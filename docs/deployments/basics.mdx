...
It is important to understand that Now keeps track of [**sources and outputs**](/docs/v2/deployments/builds#sources-and-outputs). If we add the [special pathname](/docs/v2/deployments/concepts/special-paths) `/_src` at the end of the deployment, we will be able to inspect them:
