...
export const meta = {
  title: 'Official Static Builder (@now/static)',
  description: 'The official Static Builder for ZEIT Now. Deploy any file statically quickly and with ease.'
}

### Static (@now/static)
This module is used to include **source files** as [**Build outputs**](/docs/v2/deployments/builds#sources-and-outputs). You can think of `@now/static` as a module that *copies over* files.
