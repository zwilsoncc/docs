...
export const meta = {
  title: 'Official OptiPNG Builder (@now/optipng)',
  description: 'The official OptiPNG Builder for ZEIT Now. Compress images that are deployed to Now with no additional configuration.'
}
