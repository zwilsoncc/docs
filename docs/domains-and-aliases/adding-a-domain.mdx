...
export const meta = {
  description: 'Adding and using a domain to use with deployments on Now.'
}
...
1. <GenericLink href="#1.-using-a-now.sh-domain">Using a now.sh domain</GenericLink>
2. <GenericLink href="#2.-using-a-custom-domain,-managed-by-now">Using a custom domain, managed by now</GenericLink>
3. <GenericLink href="#3.-using-a-custom-domain,-dns-managed-by-now">Using a custom domain, DNS managed by now</GenericLink>
4. <GenericLink href="#4.-using-a-custom-domain-with-a-cname">Using a custom domain with a CNAME</GenericLink>
...
<Card title="Read Next: Aliasing a Deployement" href="/docs/v2/domains-and-aliases/aliasing-a-deployment">
  Learn how to alias your deployments.
</Card>
