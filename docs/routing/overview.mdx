...
export const meta = {
  ...
  description: 'The routing layer of Now sits in between the internet and your deployments. It routes the users requests to the correct files of the requested deployment.'
}
...
<Note>When taking advantage of this behaviour of the platform, it is very important to understand that Now is not resolving the keyword `all` to all the available regions.</Note>
