...
To configure the behavior of this Builder to affect specific files explicitly, see the [Advanced Static Builds Configuration section](#advanced-usage/advanced-static-builds-configuration).
