...
To work with UIHooks using either Safari or Firefox, you will require the use of a tunnelling service such as <GenericLink href="https://ngrok.com/">ngrok</GenericLink>.

When using <InlineCode>ngrok</InlineCode>, the command <InlineCode>ngrok http 5000</InlineCode> will provide you with an address that can be used in the <P.B>UI Hook URL</P.B> field.
