...
export const meta = {
  editUrl:
    'pages/docs/integrations/v2/integrations-docs-mdx/creating-an-integration/deploy-to-production.mdx',
...
<Caption>Deploying a UIHook to <GenericLink href="/docs/v2/custom-domains#deploying-with-your-domain">a production environment</GenericLink>.</Caption>
