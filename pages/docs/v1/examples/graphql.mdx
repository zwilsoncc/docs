...
export const meta = {
  ...
  date: '01 March 2017',
  editUrl: 'pages/docs/v1/examples/graphql.mdx',
...
<TerminalInput>{`mkdir graphql-api && cd graphql-api`}</TerminalInput>
...
<Image
  src={`${process.env.IMAGE_ASSETS_URL}/docs/graphql/api.png`}
  width="550"
  height="307"
/>
...
To install it, run this [command](https://docs.npmjs.com/cli/install) in a separate terminal tab (please ensure that you're inside the "graphql-client" directory):

<TerminalInput>npm install --save react-apollo</TerminalInput>
...
<Image
  src={`${process.env.IMAGE_ASSETS_URL}/docs/graphql/client.png`}
  width="550"
  height="307"
/>
