...
export const meta = {
  ...
  date: '23 Feb 2017',
  editUrl: 'pages/docs/v1/examples/chat.mdx',
...
<Image
  src={`${process.env.IMAGE_ASSETS_URL}/docs/realtime-chat/server.png`}
  width={550}
  height={345}
/>
...
<Image
  src={`${process.env.IMAGE_ASSETS_URL}/docs/realtime-chat/hello-world.png`}
  width={550}
  height={307}
/>
...
<Image
  src={`${process.env.IMAGE_ASSETS_URL}/docs/realtime-chat/form.png`}
  width={550}
  height={307}
/>
...
<Image
  src={`${process.env.IMAGE_ASSETS_URL}/docs/realtime-chat/connected.png`}
  width={550}
  height={345}
/>
...
<Image
  src={`${process.env.IMAGE_ASSETS_URL}/docs/realtime-chat/disconnected.png`}
  width={550}
  height={345}
/>
...
<Image
  src={`${process.env.IMAGE_ASSETS_URL}/docs/realtime-chat/result.gif`}
  width={600}
  height={572}
/>
