...
export const meta = {
  ...
  date: '23 Feb 2017',
  editUrl: 'pages/docs/v1/examples/static.mdx',
...
<Image
  src={`${process.env.IMAGE_ASSETS_URL}/docs/static/browser.png`}
  width="550"
  height="319"
/>
...
<TerminalOutput>
  <b style={{ fontWeight: 'normal', color: '#fd7cfc' }}>INFO:</b> Accepting
