...
export const meta = {
  ...
  date: '28 Feb 2017',
  editUrl: 'pages/docs/v1/examples/slack-slash.mdx',
...
<TerminalInput>mkdir slash-command && cd slash-command</TerminalInput>
...
<TerminalInput>npm install --save micro yahoo-weather</TerminalInput>
...
<Note>
  In the case of a real service (not used for testing purposes), you would now
  have to{' '}
  <InternalLink href="/docs/features/aliases">assign an alias</InternalLink> to
  it.
</Note>
...
<Image
  src={`${process.env.IMAGE_ASSETS_URL}/docs/slack-slash/add-configuration.png`}
  width="500"
  height="321"
/>

You'll be redirected to another page where you can enter the name of the new slash command. In our case, it will be `/weather`. Enter it and click on the green button at the bottom.
...
<Image
  src={`${process.env.IMAGE_ASSETS_URL}/docs/slack-slash/auto-complete.png`}
  width="600"
  height="214"
/>
