...
export const meta = {
  ...
  date: '20 Feb 2017',
  editUrl: 'pages/docs/v1/examples/json-api.mdx',
...
<TerminalOutput>
  &gt; Ready! Listening on <b>http://0.0.0.0:3000</b>
</TerminalOutput>

Go to the URL returned (`http://0.0.0.0:3000`) and you should see something like this:

<Image
  src={`${process.env.IMAGE_ASSETS_URL}/docs/json-api/date.png`}
  width="550"
  height="279"
/>
...
<Image
  src={`${process.env.IMAGE_ASSETS_URL}/docs/json-api/members.png`}
  width="600"
  height="373"
/>
