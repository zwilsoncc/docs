...
export const meta = {
  ...
  description:
    'Creating a single page web app with Create React App and deploying it with Now',
  date: '08 September 2018',
  editUrl: 'pages/docs/v1/examples/create-react-app.mdx',
  image:
    process.env.IMAGE_ASSETS_URL +
    '/docs/examples/create-react-app/twitter-card.png',
...
<TerminalInput>npx create-react-app my-app</TerminalInput>

<Caption>
  Running <InlineCode>create-react-app</InlineCode> to build an application in
  the <InlineCode>my-app</InlineCode> directory with{' '}
...
<Caption>
  A <InlineCode>now.json</InlineCode> configuration setting deployment type as{' '}
  <InlineCode>static</InlineCode> and enabling the rewriting of all paths to
  point to <InlineCode>index.html</InlineCode>.
</Caption>
...
<Caption>
  A <InlineCode>.dockerignore</InlineCode> file that is whitelisting the{' '}
  <InlineCode>src</InlineCode> and <InlineCode>public</InlineCode> directories
