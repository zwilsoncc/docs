...
This means that - when running `vc` inside your terminal - your project will be launched into a secure Docker container on our platform, completely isolated from other customers and even your other containers.
...
Old deployments always stay around forever if you don't remove them using `vc remove`.
