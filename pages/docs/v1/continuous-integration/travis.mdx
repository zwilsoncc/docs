...
## Step 1: Getting a <ProductNameWrapper name={PRODUCT_SHORT_V1_NAME} /> Token
...
## Step 3: Configuring Travis to deploy with <ProductNameWrapper name={PRODUCT_SHORT_V1_NAME} /> using your Token
...
## Optional: Avoid building on <ProductNameWrapper name={PRODUCT_SHORT_V1_NAME} /> (Instead build on Travis)
