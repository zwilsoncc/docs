...
If you are building a [Next.js](https://github.com/vercel/next.js) application with a [custom server](https://github.com/vercel/next.js#custom-server-and-routing) you can add the following to your configuration file.
