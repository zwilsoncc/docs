...
export const meta = {
  ...
  description: `Deploy your changes in your GitHub repositories after every push using Travis CI and ${PRODUCT_SHORT_NAME_V1}`,
  date: '13 Mar 2018',
...
## Step 1: Getting a <ProductNameWrapper name={PRODUCT_SHORT_NAME_V1} /> Token
...
## Step 3: Configuring Travis to deploy with <ProductNameWrapper name={PRODUCT_SHORT_NAME_V1} /> using your Token
...
## Optional: Avoid building on <ProductNameWrapper name={PRODUCT_SHORT_NAME_V1} /> (Instead build on Travis)
