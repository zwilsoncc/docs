...
export const meta = {
  title: 'Restrictions',
  description: `A guide to what restrictions you have when deploying to ${PRODUCT_SHORT_V1}`,
  date: '20 Mar 2018',
...
enforced upon the content you have uploaded to <ProductNameShortV1 />.
...
our [Pricing](/pricing/v1) page), we
...
won't be able to access any of <ProductNameShortV1 />'s features
