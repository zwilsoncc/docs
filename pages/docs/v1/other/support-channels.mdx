...
export const meta = {
  ...
  description: `Finding help beyond documentation for ${PRODUCT_SIMPLE} and Now`,
  date: '21 Jul 2017',
...
<ProductNameSimple /> has a community which is hosted on Spectrum. There, you will be able to ask for help and get a response from either the community or the <ProductNameSimple /> team. [Join the community](/chat) to get involved, ask for help, or give advice!
