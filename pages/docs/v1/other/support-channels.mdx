...
import { ORGANIZATION, PRODUCT_SHORT_NAME_V1 } from '~/lib/constants'

export const meta = {
  title: 'Support Channels',
  description: `Finding help beyond documentation for ${ORGANIZATION} and ${PRODUCT_SHORT_NAME_V1}`,
  date: '21 Jul 2017',
...
<OrgNameV1 /> has a community which is hosted on Spectrum. There, you will be able to ask for help and get a response from either the community or the <OrgNameV1 /> team. [Join the community](/chat) to get involved, ask for help, or give advice!
