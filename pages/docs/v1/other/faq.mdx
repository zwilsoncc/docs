...
export const meta = {
  ...
  description: `The answers to our most frequently asked questions for Now and other ${ORGANIZATION} products and services`,
  date: '30 Jan 2018',
...
For now, it is not possible to transfer a domain into <OrgNameV1 /> Domains, but you can [change your domain nameservers to point to zeit.world](https://zeit.co/world) to use Now as a DNS.
