...
import { PRODUCT_SHORT_V1, ORGANIZATION } from '~/lib/constants'
import CliNameV1 from '~/components/product-name/cli-name-v1'

export const meta = {
  title: 'Frequently Asked Questions',
  description: `The answers to our most frequently asked questions for ${PRODUCT_SHORT_V1} and other ${ORGANIZATION} products and services`,
  date: '30 Jan 2018',
  editUrl: 'pages/docs/v1/other/faq.mdx',
  lastEdited: '2020-04-13T15:52:00.000Z'
}
...
## Can I run a database on the <ProductNameWrapper name={PRODUCT_SHORT_V1} /> platform?
...
## Can I use docker-compose with <ProductNameWrapper name={PRODUCT_SHORT_V1} />?
...
## Can I run a bot on <ProductNameWrapper name={PRODUCT_SHORT_V1} />?
...
## Is It possible to host WordPress on the <ProductNameWrapper name={PRODUCT_SHORT_V1} /> Platform?

Check our WordPress example repository.

> <https://github.com/now-examples/wordpress>

## Is it possible to host Ghost on the <ProductNameWrapper name={PRODUCT_SHORT_V1} /> Platform?
...
## How do I set up an email for a domain purchased through <ProductNameWrapper name={PRODUCT_SHORT_V1} /> Domains?
...
## Does <ProductNameWrapper name={PRODUCT_SHORT_V1} /> support wildcard subdomains?
...
## How do I run scheduled tasks on the <ProductNameWrapper name={PRODUCT_SHORT_V1} /> platform?
...
## Is it possible to upload files to a running <ProductNameWrapper name={PRODUCT_SHORT_V1} /> instance?
...
## Does <ProductNameWrapper name={PRODUCT_SHORT_V1} /> offer support for IPv6?

We do not currently offer support for IPv6.

## Does <ProductNameWrapper name={PRODUCT_SHORT_V1} /> block outgoing connections in any way?
...
## Is <ProductNameWrapper name={PRODUCT_SHORT_V1} /> GDPR compliant?
...
## Why does <ProductNameWrapper name={PRODUCT_SHORT_V1} /> give me random URLs and how can I change it?
...
## How can I use a separate <ProductNameWrapper name={PRODUCT_SHORT_V1} /> configuration for staging and production?
