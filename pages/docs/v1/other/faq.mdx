...
import CliV1 from '~/components/product-name/cli-v1'
import ProductNameShortV1 from '~/components/product-name/short-v1'
...
Whenever you upload files using <CliV1 />, a new deployment is
...
This is not currently possible to do via the [<CliV1 />](/docs/clients/now-cli), but you can contact us at [support@zeit.co](mailto:support@zeit.co?subject=Change%20Purchased%20Domain%20Nameserver) with your desired nameservers and, after a security verification of the ownership, we can change them for you.
