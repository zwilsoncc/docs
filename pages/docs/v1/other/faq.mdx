...
export const meta = {
  ...
  description:
    'The answers to our most frequently asked questions for Now and other ZEIT products and services',
  date: '30 Jan 2018',
  editUrl: 'pages/docs/v1/other/faq.mdx',
  lastEdited: '2019-08-26T20:39:29.000Z'
}
...
If you need to transfer your domain out of ZEIT Domains, you can contact us at [support@zeit.co](mailto:support@zeit.co?subject=Domain%20Transfer) with the domain you would like to transfer.
