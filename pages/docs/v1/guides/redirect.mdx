...
export const meta = {
  title: `Setting up a Redirect with ${PRODUCT_SHORT_V1_NAME}`,
  description: `Redirecting your ${PRODUCT_SHORT_V1_NAME} deployed app using ${PRODUCT_SHORT_V1_NAME} Alias or from within your app`,
  date: '5 Nov 2017',
  editUrl: 'pages/docs/v1/guides/redirect.mdx',
...
<TerminalInput>
  now -e REDIRECT_URL=https://mycompany.com/ now-examples/redirect
</TerminalInput>
...
<TerminalInput>
  now alias https://now-redirect-otytioldup.now.sh www.mycompany.com
</TerminalInput>
...
Then, every time you run `vercel alias`, it will alias your app into both of your aliases.
