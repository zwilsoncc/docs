...
export const meta = {
  title: `Setting up a Redirect with ${PRODUCT_SHORT_V1}`,
  description: `Redirecting your ${PRODUCT_SHORT_V1} deployed app using ${PRODUCT_SHORT_V1} Alias or from within your app`,
  date: '5 Nov 2017',
