...
export const meta = {
  ...
  editUrl: 'pages/docs/v1/guides/how-to-use-cloudflare.mdx',
...
<Image
  ...
  }/docs/how-to-use-cloudflare/cloudflare-now-txt.png`}
  width={600}
  height={336}
/>
...
<Image
  src={`${
    process.env.IMAGE_ASSETS_URL
  }/docs/how-to-use-cloudflare/cloudflare-dns-records.png`}
  width={600}
  height={259}
/>
...
<Image
  src={`${
    process.env.IMAGE_ASSETS_URL
  }/docs/how-to-use-cloudflare/cloudflare-dns-proxy-mode.png`}
  width={600}
  height={259}
/>
...
<Image
  src={`${
    process.env.IMAGE_ASSETS_URL
  }/docs/how-to-use-cloudflare/cloudflare-full-strict-ssl.png`}
  width={600}
  height={321}
/>
...
<Image
  src={`${
    process.env.IMAGE_ASSETS_URL
  }/docs/how-to-use-cloudflare/cloudflare-page-rule-ssl-off.png`}
  width={600}
  height={344}
/>
...
<Image
  src={`${
    process.env.IMAGE_ASSETS_URL
  }/docs/how-to-use-cloudflare/cloudflare-page-rules-ssl-off-on-top.png`}
  width={600}
  height={107}
/>
