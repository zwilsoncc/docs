...
export const meta = {
  ...
  description: `A guide for your app's deployment lifecycle on ${PRODUCT_SHORT_V1} and how to scale that deployment`,
  date: '09 March 2017',
  editUrl: 'pages/docs/v1/guides/app-lifecycle-and-scalability.mdx',
  lastEdited: '2020-04-13T05:57:53.000Z'
}

In this guide, we are going to have a look at how <ProductNameShortV1 /> deploy and manage your app inside its infrastructure.
