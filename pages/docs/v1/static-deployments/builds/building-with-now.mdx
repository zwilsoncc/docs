...
export const meta = {
  ...
  lastEdited: '2020-04-13T08:24:40.000Z'
}
...
Although having a `now.json` is the preferred method for configuring your app deployments, you can also use the following with [<CliV1 />](/docs/clients/now-cli):
...
> Make sure you have the latest version of the <CliV1 /> to utilize static builds.<br/> You can get it from [zeit.co/download](https://zeit.co/download).
