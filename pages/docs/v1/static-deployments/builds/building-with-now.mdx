...
## An example of building and deploying a Static Next.js App to <ProductNameWrapper name={PRODUCT_SHORT_V1_NAME} />
...
### Step 3: Configuring <ProductNameWrapper name={PRODUCT_SHORT_V1_NAME} /> for Static deployments
...
> Make sure you have the latest version of the <CliV1Name /> to utilize static builds.<br/> You can get it from [zeit.co/download](https://zeit.co/download).
