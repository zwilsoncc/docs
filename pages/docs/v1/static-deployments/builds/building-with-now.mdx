...
export const meta = {
  ...
  date: '12 July 2018',
  editUrl: 'pages/docs/static-deployments/builds/building-with-now.mdx',
...
<Caption>
  ...
  <GenericLink href="https://nextjs.org">Next.js static exports</GenericLink>.
</Caption>
...
<Caption>
  ...
  scripts we made in{' '}
  <GenericLink href="#step-1:-preparing-the-app-for-export">Step 1</GenericLink>
  .
</Caption>
...
<Caption>
  ...
  <GenericLink href="/docs/features/configuration">configuring Now</GenericLink>
  .
</Caption>
