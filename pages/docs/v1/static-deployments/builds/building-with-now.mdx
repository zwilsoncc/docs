...
export const meta = {
  title: 'Static Builds',
  description:
    'Using a Dockerfile to build and deploy a static app all from within Now',
  date: '12 July 2018',
...
With <ProductNameShortV1 />, you can build static apps when deploying using a `Dockerfile`. You can build a static app however you wish and then output the content in a directory called `/public` for Now to upload after the build.
...
<Caption>
  ...
  <Link href="/docs/features/configuration">configuring Now</Link>.
</Caption>
