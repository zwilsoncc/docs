...
Take a look at the live example: <https://vercel.com/zeit/now-jekyll/slxipttlce>
...
You can use a `now.json` configuration file and the `vercel secrets` command in tandem for use with the build step for static deployments.
