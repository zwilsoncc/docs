...
Each time you create a new deployment, you will get a new unique subdomain. For this address (just like for the custom domains you've added using `vercel alias` or `vercel alias`), we're automatically provisioning an SSL certificate for you.
