...
4. HTTP requests are being redirected to HTTPS (for example <Link href="/docs/guides/how-to-use-cloudflare#cloudflare-as-a-proxy-server">when using Cloudflare</Link>)
