...
export const meta = {
  ...
  lastEdited: '2019-11-06T16:24:15.000Z'
}
...
This example describes how to install dependencies for a [static app build](/docs/deployment-types/static). The `Dockerfile` holds an [`ARG` instruction](https://docs.docker.com/engine/reference/runtime/#arg) that relates to the recently created `NPM_TOKEN` environment variable.
...
<Caption>
  ...
  <Link href="https://docs.docker.com/engine/reference/runtime/#arg">
