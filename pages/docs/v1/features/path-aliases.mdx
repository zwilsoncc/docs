...
export const meta = {
  ...
  description: `Aliasing microservices to exist in different locations with your domain on ${PRODUCT_SHORT_V1_NAME}`,
  date: '15 Mar 2017',
...
If you [manage](/docs/getting-started/assign-a-domain-name#2.-using-a-custom-domain,-managed-by-now) your domain inside <OrgV1Name /> or [point it](/docs/getting-started/assign-a-domain-name#4.-using-a-custom-domain-with-a-cname) to `alias.zeit.co`, you can hide microservices under a domain as shown above with our "Path Alias" feature.
...
Destinations of these rules are unique <ProductShortV1Name /> deployment URLs. They will be changed every time you deploy a new version. Therefore, you need to update the rules again and again.
