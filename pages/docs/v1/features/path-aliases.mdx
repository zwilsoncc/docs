...
If you [manage](/docs/getting-started/assign-a-domain-name#2.-using-a-custom-domain,-managed-by-now) your domain inside <OrgV1Name /> or [point it](/docs/getting-started/assign-a-domain-name#4.-using-a-custom-domain-with-a-cname) to `cname.vercel-dns.com`, you can hide microservices under a domain as shown above with our "Path Alias" feature.
