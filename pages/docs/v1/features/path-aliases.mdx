...
Destinations of these rules are unique <ProductShortNameV1 /> deployment URLs. They will be changed every time you deploy a new version. Therefore, you need to update the rules again and again.
