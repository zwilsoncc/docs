...
<Note>
  The Now CDN is now simplified and automatic. Please see the{' '}
  <Link href="/docs/v2/network/caching/">Now 2.0 CDN documentation</Link> for
  more information. If you have no upgraded to Now 2.0 yet,{' '}
