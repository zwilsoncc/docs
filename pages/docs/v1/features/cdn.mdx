...
export const meta = {
  ...
  lastEdited: '2019-07-12T10:56:04.000Z'
}

<Note hint label="Update">
  The Now CDN is now simplified and automatic. Please see the{' '}
  <GenericLink href="/docs/v2/domains-and-aliases/cdn">
    Now 2.0 CDN documentation
  </GenericLink>{' '}
  for more information. If you have no upgraded to Now 2.0 yet,{' '}
  <GenericLink href="/guides/upgrade-to-2-0">see how</GenericLink>.
</Note>
