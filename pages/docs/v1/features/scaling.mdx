...
export const meta = {
  ...
  description: `Scaling your deployments to be instances in multiple global locations with ${PRODUCT_SHORT_NAME_V1}`,
  date: '01 Apr 2018',
...
is available in the region that you would like to enable on <ProductShortNameV1 />**.
...
When scaling deployments on <ProductShortNameV1 />, it is necessary
...
tell <ProductShortNameV1 /> where exactly it should scale
your deployment to.

​<ProductShortNameV1 /> provides a number of regions, each of which
...
In order to let <ProductShortNameV1 /> scale the deployment
...
let <ProductShortNameV1 /> scale your deployment automatically
