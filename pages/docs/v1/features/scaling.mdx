...
export const meta = {
  ...
  lastEdited: '2019-08-15T15:20:12.000Z'
}
...
Now 2.0 deployments have a larger range of regions to run Serverless Functions. Executing code closer to your customers will improve their experience by reducing latency.
</Note>
