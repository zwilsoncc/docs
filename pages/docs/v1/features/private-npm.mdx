...
export const meta = {
  ...
  description:
    'Granting permissions for your deployments to use private npm scopes ',
  date: '12 Mar 2017',
  editUrl: 'pages/docs/v1/features/private-npm.mdx',
...
<Image
  src={`${process.env.IMAGE_ASSETS_URL}/docs/private-npm/example.gif`}
  width="658"
  height="483"
/>
...
If you want to forward your [npm](https://npmjs.com/) credentials every time you create a new deployment using <ProductNameShortV1 />, you can set the `forwardNpm` property inside your global `~/.now.json` file to `true`:
...
You can read more about how to configure <ProductNameShortV1 /> to your needs <Link href="/docs/features/configuration">here</Link>.
