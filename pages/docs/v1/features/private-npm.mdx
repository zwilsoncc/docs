...
If you want to forward your [npm](https://npmjs.com/) credentials every time you create a new deployment using <ProductShortV1Name />, you can set the `forwardNpm` property inside your global `~/.now.json` file to `true`:
...
You can read more about how to configure <ProductShortV1Name /> to your needs <Link href="/docs/features/configuration">here</Link>.
