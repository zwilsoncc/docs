...
This guide explains how to use these methods to configure and customize the default behavior of Now CLI.
...
The URL of the Now API which Now CLI should interact with.
...
This describes the set of configuration rules that apply to Now CLI.
...
they're being used for. As an example, this will make Now CLI receive
canary updates:
