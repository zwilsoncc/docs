...
There are various ways to define environment variables. <ProductShortNameV1 /> you'll learn what's the right one for you.
...
- **NOW**: Is set to `1`, for detecting <ProductShortNameV1 />.
