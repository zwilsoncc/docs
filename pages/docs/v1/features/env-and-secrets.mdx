...
export const meta = {
  ...
  description: `Creating and using environment variables and creating and using secret environment variables in your ${PRODUCT_SHORT_V1} deployments`,
  date: '21 Feb 2017',
...
There are various ways to define environment variables. <ProductNameShortV1 /> you'll learn what's the right one for you.
...
- **NOW**: Is set to `1`, for detecting <ProductNameShortV1 />.
