...
export const meta = {
  ...
  lastEdited: '2019-03-13T13:19:27.000Z'
}
...
There's a fixed number of concurrent instances you can have based on the [plan](/pricing/v1) you've chosen. But with this configuration, you can have as many deployments as you want.
