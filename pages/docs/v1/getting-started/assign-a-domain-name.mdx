...
export const meta = {
  ...
  lastEdited: '2020-05-25T17:10:38.000Z'
}
...
To map the `ui.my-app.work` domain for one of the deployment URLs of your app, visit your DNS provider and add a CNAME record for `ui.my-app.work` pointing to `cname.vercel-dns.com`.
