...
export const meta = {
  ...
  description: `Setting up environment variables to use in your deployed ${PRODUCT_SHORT_V1} apps`,
  date: '6 August 2017',
...
Exposing environment variables with <ProductNameShortV1 /> is easy.
...
> It's not a good idea to commit the `now.json` file to [Git](https://en.wikipedia.org/wiki/Git) if it contains secret information. For that, consider using <Link href="/docs/getting-started/secrets"><ProductNameShortV1 /> Secrets</Link>.
