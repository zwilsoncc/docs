...
export const meta = {
  ...
  description:
    'Setting up environment variables to use in your deployed Now apps',
  date: '6 August 2017',
...
> It's not a good idea to commit the `now.json` file to [Git](https://en.wikipedia.org/wiki/Git) if it contains secret information. For that, consider using <Link href="/docs/getting-started/secrets"><Now color="#0076FF"/> Secrets</Link>.
