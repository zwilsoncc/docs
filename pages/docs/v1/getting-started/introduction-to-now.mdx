...
export const meta = {
  ...
  description:
    'A quick-start guide to deploying your dynamic and static apps with Now and what you can do with your deployments.',
  date: '30 July 2017',
...
The best way to get started with Now is by [installing <CliV1 />](/download):
