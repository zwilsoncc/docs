...
The best way to get started with <ProductNameShortV1 /> is by [installing <CliV1 />](/download):

<TerminalInput>npm i -g now</TerminalInput>
<Caption>
  Installing <CliV1 /> with npm.
</Caption>

## Step 2: Signing Up

Once you've installed <CliV1 />, use the following command to start the registration process:
