...
<Image
  src={`${process.env.IMAGE_ASSETS_URL}/docs/installation/now-desktop.png`}
  width={600}
  height={500}
/>

<Caption>
  Now Desktop running on macOS. Now Desktop is also{' '}
  <GenericLink href="/download">available on Windows</GenericLink>.
</Caption>
