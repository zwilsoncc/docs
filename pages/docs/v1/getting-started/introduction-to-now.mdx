...
export const meta = {
  ...
  lastEdited: '2020-06-04T21:10:21.000Z'
}
...
> Alternatively, use [Docker to deploy](https://github.com/vercel/now-examples#serverless-docker-v2) your dynamic applications, or use a `Dockerfile` to instruct <ProductShortV1Name /> to [build and deploy your static applications](/docs/static-deployments/builds/building-with-now).
