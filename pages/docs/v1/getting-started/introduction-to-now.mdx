...
export const meta = {
  title: `Introduction to ${PRODUCT_SHORT_NAME_V1}`,
  description: `A quick-start guide to deploying your dynamic and static apps with ${PRODUCT_SHORT_NAME_V1} and what you can do with your deployments.`,
  date: '30 July 2017',
  editUrl: 'pages/docs/v1/getting-started/introduction-to-now.mdx',
  lastEdited: '2020-04-13T20:57:18.000Z'
}

With <ProductShortNameV1 />'s help, you can deploy and publish any kind of web application (or service) in
under five minutes.
...
## Step 1: Getting <ProductNameWrapper name={PRODUCT_SHORT_NAME_V1} />

The best way to get started with <ProductShortNameV1 /> is by [installing <CliNameV1 />](/download):
...
> Alternatively, use [Docker to deploy](https://github.com/zeit/now-examples#serverless-docker-v2) your dynamic applications, or use a `Dockerfile` to instruct <ProductShortNameV1 /> to [build and deploy your static applications](/docs/static-deployments/builds/building-with-now).

After you have added the content, change to the `my-web-app` directory in your terminal and run this command:

<TerminalInput>now</TerminalInput>

​<ProductShortNameV1 /> will deploy the app and give you a URL as shown below:
...
These are just a few things you can do with <ProductShortNameV1 />. To do more with <ProductShortNameV1 />, follow the rest of the docs.
