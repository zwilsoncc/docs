...
export const meta = {
  title: 'Secrets',
  description: `Configuring your apps with environment variables that shouldn't be public using ${PRODUCT_SHORT_V1_NAME} Secrets`,
  date: '6 August 2017',
...
## <ProductNameWrapper name={PRODUCT_SHORT_V1_NAME} /> Secrets

That's where <ProductShortV1Name /> Secrets can help you. It's a configuration store that works across your account. Let's see how to use it:
...
You can perform a few sets of operations with <ProductShortV1Name /> Secrets, including adding, renaming and removing secrets. But you can't read secrets from the terminal.
...
You can get more information about <ProductShortV1Name /> Secrets by running the following Help command:
