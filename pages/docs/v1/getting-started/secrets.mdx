...
export const meta = {
  title: 'Secrets',
  description: `Configuring your apps with environment variables that shouldn't be public using ${PRODUCT_SHORT_NAME_V1} Secrets`,
  date: '6 August 2017',
...
## <ProductNameWrapper name={PRODUCT_SHORT_NAME_V1} /> Secrets
