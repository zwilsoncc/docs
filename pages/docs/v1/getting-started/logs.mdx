...
export const meta = {
  title: 'Logs',
  description: `Using ${PRODUCT_SHORT_V1} logs to keep track of your deployment activity`,
  date: '4 August 2017',
  editUrl: 'pages/docs/v1/getting-started/logs.mdx',
  lastEdited: '2020-04-13T05:57:53.000Z'
}

Logs are important because it allows you to see what's happening inside the app, especially when a crisis happens. <ProductNameShortV1 /> keeps logs of all of your deployments and allows you to search them.
