...
By default, all deployments expose the `NOW_REGION` environment variable to [lambdas](/docs/v2/advanced/concepts/lambdas) which provides the [region](/docs/v2/advanced/platform/regions-and-providers/) that the lambda was deployed to.
