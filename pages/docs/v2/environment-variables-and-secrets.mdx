...
By default, all deployments expose the `NOW_REGION` environment variable to [Serverless Functions](/docs/v2/advanced/concepts/serverless-functions) which provides the [region](/docs/v2/advanced/platform/regions-and-providers/) that the lambda was deployed to.
