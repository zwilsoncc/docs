...
export const meta = {
  ...
  lastEdited: '2020-02-20T05:41:15.000Z'
}

To start deploying on ZEIT Now,

A Project is a logical structure that groups [deployments](/docs/v2/platform/deployments)

and [custom domains](/docs/v2/custom-domains). This structure allows easier tracking and managing of deployments.
