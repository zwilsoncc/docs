...
export const meta = {
  title: 'Projects',
  description: `Setting up projects with a list of deployments on ${PRODUCT}.`,
  editUrl: 'pages/docs/v2/platform/projects.mdx',
  lastEdited: '2020-04-11T07:31:56.000Z'
}
...
You can create a new project from the <ProductNameSimple /> Dashboard by clicking on [the New Project button](/new).
...
<Image
  ...
  shadow
/>
<Caption>Creating a new project from the <ProductNameSimple /> Dashboard.</Caption>
...
<Image
  ...
  shadow
/>
<Caption>Selecting the project from the <ProductNameSimple /> Dashboard.</Caption>
