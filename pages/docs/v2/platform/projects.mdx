...
export const meta = {
  ...
  lastEdited: '2020-04-30T07:51:06.000Z'
}
...
<Note>
  This feature is <em>not</em> available for personal accounts. In order to be
  able to opt into this feature, you must be on a <b>team</b>, and the team must
  be on the <b>Pro</b> or <b>Enterprise</b> plan.
</Note>
...
Teams can opt into using this feature by enabling it from the "Optional" badge item and paying <DollarSign />150 per month. Once it’s enabled in one project, you can use it across other projects in the same team:
...
After clicknig **Save**, all Preview Deployments (existing and future ones) will immediately be protected with a password. If you try to access the page, you’ll be presented with this screen:
...
After entering the password, you’ll be redirected to the deployment. Also, u cookie will be set in the visitor’s browser, giving them access to the Preview Deployment.
...
To protection Production Deployments in addition to Preview Deployments, check **“Also protect my Production Deployment"** and click **Save**.

#### Technical Details

- If you change the password, visitors who have entered the password before will need to re-enter the password.
- If you disable the protection and then enable it, visitors who have the cookie set will continue to be able to access the page without re-entering the password.
- You can use Password Protection in conjunction with [SSO Protection](#sso-protection).

#### Disabling the Feature

To stop using this feature completely, you can do so from your team’s **Settings** → **Billing** page. Click **Edit** next to **Password Protection** and follow the instructions:
...
By using **SSO Protection**, you can ensure that visitors of your Preview Deployments must log in with a Vercel account that is a member of your team to gain access.
...
To use this feature, turn on the toggle.
...
After clicknig **Save**, all Preview Deployments (existing and future ones) will immediately require logging in with a Vercel account, and the account must be a member of your team. If you try to access the page, you’ll be presented with this screen:
...
If you log in with a Vercel account that’s a member of your team, you’ll be redirected to the deployment. Also, a cookie will be set in the visitor’s browser, giving them access to the Preview Deployment.
...
- If you disable the protection and then enable it, visitors who have the cookie set will continue to be able to access the page without logging in again.
