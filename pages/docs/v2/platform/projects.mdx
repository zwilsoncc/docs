...
export const meta = {
  ...
  lastEdited: '2020-04-30T23:22:00.000Z'
}
...
If a visitor logs in with a Vercel account that’s a member of your team, the visitor will be redirected to the deployment. Also, a cookie will be set in the visitor’s browser, giving them access to Preview Deployments.
