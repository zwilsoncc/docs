...
export const meta = {
  ...
  lastEdited: '2020-04-30T07:19:51.000Z'
}
...
After entering the password, a cookie will be set in the visitor’s browser, giving them access to the Preview Deployment.
