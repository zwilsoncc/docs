...
After clicking **Save**, all Preview Deployments (existing and future ones) will immediately require logging in with a Vercel account, and the account must be a member of your team. If you try to access the page, you’ll be presented with this screen:
