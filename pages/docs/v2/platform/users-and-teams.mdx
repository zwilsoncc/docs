...
export const meta = {
  ...
  description: 'Using ZEIT Now with a scope of a user or a team and how to manage them.'
}
...
<Note>For more information on the teams API endpoint, see our <GenericLink href="/docs/api/v2#endpoints/teams">API reference documentation</GenericLink>.</Note>
