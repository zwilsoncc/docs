...
export const meta = {
  ...
  description: `Using ${PRODUCT} with a scope of a user or a team and how to manage them.`,
  editUrl: 'pages/docs/v2/platform/users-and-teams.mdx',
  lastEdited: '2020-04-11T07:32:38.000Z'
}
...
If you are part of one or multiple teams, you can choose which to show project information for or manage from the [<ProductNameSimple /> Dashboard](/dashboard). To do this, click on your avatar on the top left, then select the team of your choice:
...
<Image src={`https://assets.zeit.co/image/upload/v1541367164/front/docs/users-and-teams/user-settings.png`}
  ...
  height={276/2}
/>
<Caption>Switching teams from the <ProductNameSimple /> Dashboard account bar.</Caption>
