...
export const meta = {
  ...
  lastEdited: '2020-06-24T19:46:32.000Z'
}
...
- Allows configuration of the amount of memory that the Serverless Function is given.
- More stable because it requires a specific npm package version for the `runtime` property.
- Supports "clean URLs" by default, so the file extension is not required in the URL.
