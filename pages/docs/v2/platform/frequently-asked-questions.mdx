...
[<ProductNameShort /> CLI](/download) will automatically upgrade your deployment to the latest platform version if you import a project or if your project meets certain criteria. In order for this to work, you must:
...
## What can I deploy with <ProductNameWrapper name={PRODUCT} />?
...
<Note>
  This is only relevant if you’re using <ProductNameShort /> CLI 16.7.3 or
  older.
</Note>
