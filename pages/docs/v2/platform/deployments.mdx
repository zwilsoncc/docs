...
By appending `/_src` to a deployment URL or [custom domain](/docs/v2/custom-domains), the deployment inspector will be open and you'll be able to browse your deployment sources and [build](/docs/v2/advanced/runtimes) outputs.
