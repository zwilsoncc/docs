...
export const meta = {
  ...
  lastEdited: '2020-05-13T14:38:41.000Z'
}
...
The maximum number of [Environment Variables](/docs/v2/build-step#environment-variables) per Environment per Project is **100**. For example, you can not
have more than 100 Production Environment Variables.
