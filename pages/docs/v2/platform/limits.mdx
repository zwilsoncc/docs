...
export const meta = {
  ...
  lastEdited: '2020-07-03T19:28:05.000Z'
}
...
You are able to deploy a total of `160` [Serverless Functions](/docs/v2/serverless-functions/introduction/) per month. Each [Deployment](/docs/v2/platform/deployments)'s number of Serverless Functions will count toward the `160` Serverless Functions per month. Should you exceed this general limit, you will need to wait till the current month ends before you can deploy more Serverless Functions.
