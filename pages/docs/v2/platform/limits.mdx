...
export const meta = {
  ...
  lastEdited: '2020-04-10T20:55:41.000Z'
}
...
The maximum amount of domains that can be applied to a single project, either from the ZEIT Dashboard or by using the API is **50**. If your project requires more than 50 domains, please [contact our enterprise team](mailto:enterprise@zeit.co).
