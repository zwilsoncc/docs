...
export const meta = {
  title: 'Glossary',
  description: `A list of the terms used in context of ${PRODUCT} and what those terms mean or describe.`,
  editUrl: 'pages/docs/v2/platform/glossary.mdx',
  lastEdited: '2020-04-08T06:29:35.000Z'
}

These are the terms we encourage you to learn in order to deeply understand **<ProductName />**. However, every occurrence of one of these terms is also linked back to this very page, so that you can always jump right to the explanation if needed.
...
The company behind the product **<ProductName />**.
...
The command line interface client for **<ProductName />**.
