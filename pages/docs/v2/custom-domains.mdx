...
export const meta = {
  ...
  lastEdited: '2020-06-17T14:31:21.000Z'
}
...
<Note label={false}>
  If you want to migrate an <b>existing domain</b> to Vercel, read our guide on{' '}
  <Link href="/knowledge/zero-downtime-migration-for-dns">
...
Once a Domain has been added, all of its DNS Records can be found in the Advanced Settings page.
From there, you can view and manage the records.

### Step 1: Selecting your Domain

On the [dashboard](/dashboard), click on the **Domains** tab:

<Image
  src={`${process.env.ASSETS}/docs/custom-domains/select-domains-tab-2.png`}
  width={982 / 2}
  height={732 / 2}
  shadow
/>
...
<Image
  src={`${process.env.ASSETS}/docs/custom-domains/deploy-new-domain.png`}
  width={2158 / 2}
  height={978 / 2}
  shadow
/>
<Caption>Selecting the Domain to view its Advanced Settings page.</Caption>
...
<Image
  src={`${process.env.ASSETS}/docs/custom-domains/dns-record-form.png`}
  width={2068 / 2}
  height={646 / 2}
  shadow
/>
<Caption>DNS Records form to add a new DNS Record.</Caption>
