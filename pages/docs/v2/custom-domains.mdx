...
export const meta = {
  ...
  lastEdited: '2019-10-09T12:56:09.000Z'
}
...
Once the domain has been added, you will be presented with two methods for verifying it, either through **Nameservers** or **TXT**.
