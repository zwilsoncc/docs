...
export const meta = {
  ...
  lastEdited: '2019-08-12T19:06:55.000Z'
}
...
Once the domain has been added, the interface will update to reflect this along with further information such as instructions on how to use it, read on to learn more about how to use it, here.
