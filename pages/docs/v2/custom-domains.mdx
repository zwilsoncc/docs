...
export const meta = {
  ...
  lastEdited: '2020-05-01T00:52:25.000Z'
}
...
By default, the URL of every new Preview Deployment ends with `.now.sh`. You can change this by modifying Preview Deployment Suffix.

Teams can opt into using this feature by going to your team’s **Settings** page:

<Image
  src={`${process.env.ASSETS}/docs/custom-domains/team-settings.png`}
  width={1540 / 2}
  height={386 / 2}
  shadow
/>
<Caption>Going to your team’s <b>Settings</b> page.</Caption>

Then, from the **Preview Deployment Suffix** fieldset, click the **Optional** badge. The team will be billed <DollarSign />100 per month.

<Image
  src={`${process.env.ASSETS}/docs/custom-domains/enable-preview-deployment-suffix.png`}
  width={896 / 2}
  height={372 / 2}
  shadow
/>
<Caption>Enabling <b>Preview Deployment Suffix</b>.</Caption>

**Important**: Only domains that are **already added to one of your team’s projects** can be used for Preview Deployment Suffix.

<Note>
  Suppose that you’d like to use <InlineCode>preview.example.com</InlineCode> as
  Preview Deployment Suffix. We suggest creating a project that renders a
  nice-looking page or redirects somewhere, and assigning{' '}
  <InlineCode>preview.example.com</InlineCode> to this project. This improves
  the visitor’s experience if they accidentally access{' '}
  <InlineCode>preview.example.com</InlineCode>.
</Note>

### Details

- If you update Preview Deployment Suffix, it will only be applied to **new** deployments.

#### Disabling the Feature

To opt out from this feature, you can do so from your team’s **Settings** → **Billing** page. Click **Edit** next to **Preview Deployment Suffix** and follow the instructions:

<Image
  src={`${process.env.ASSETS}/docs/custom-domains/cancel-preview-deployment-suffix.png`}
  width={506 / 2}
  height={90 / 2}
  shadow
  borderRadius
/>
<Caption>Disable the Preview Deployment Suffix Feature.</Caption>
