...
To prevent Now from canceling in-progress builds to prioritise building newer commits, use the following configuration option in [a `now.json` file](/docs/configuration) for the repository that this behavior should exist in.
