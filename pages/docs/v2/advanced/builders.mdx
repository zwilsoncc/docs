...
export const meta = {
  ...
  lastEdited: '2019-08-02T16:15:51.000Z'
}

Builders are [modules](https://zeit.co/docs/v2/deployments/builders/developer-guide/) that transform your [source code into compiled outputs](/docs/v2/deployments/builds#sources-and-outputs), being either static files and/or [Serverless Functions](https://zeit.co/docs/v2/deployments/concepts/lambdas/), which are served by our [CDN at the edge](https://zeit.co/docs/v2/advanced/domains/cdn/).
