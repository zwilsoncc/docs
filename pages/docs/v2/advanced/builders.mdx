...
export const meta = {
  ...
  lastEdited: '2019-08-12T19:10:19.000Z'
}
...
Extending the feature-set of a Now deployment is as simple as creating a Builder that takes a list of files and outputs either static files or dynamic [Serverless Functions](/docs/v2/advanced/concepts/lambdas).
