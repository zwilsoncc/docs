...
export const meta = {
  ...
  editUrl: 'pages/docs/v2/advanced/builders-developer-reference.mdx',
  lastEdited: '2019-08-02T17:08:35.000Z'
}
...
An **optional** exported function that is only used by `now dev` in [Now CLI](/download) and indicates whether a [Builder](/docs/v2/deployments/builders/overview/) wants to be responsible for building a certain request path.
