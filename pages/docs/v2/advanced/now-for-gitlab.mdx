...
export const meta = {
  ...
  description:
    'Deploy each change in your GitLab projects with ZEIT Now to share and test with your colleagues. Instant share-able links to your work with each push. Automatically alias your changes to production.',
  editUrl: 'pages/docs/v2/advanced/now-for-gitlab.mdx',
  lastEdited: '2019-08-22T10:47:21.000Z'
}

The Now for GitLab integration automatically deploys and aliases your GitLab projects with [ZEIT Now](/now).
