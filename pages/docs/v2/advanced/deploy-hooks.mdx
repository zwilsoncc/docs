...
export const meta = {
  ...
  lastEdited: '2019-07-29T15:57:20.000Z'
}
...
To create a Deploy Hook, the first thing you need to do is to install <GenericLink href="/docs/v2/now-for-github">Now for GitHub</GenericLink> or <GenericLink href="/docs/v2/now-for-gitlab">Now for GitLab</GenericLink>. This allows you to link a ZEIT project to a new or existing Git repository or project.

<Image
src={`${process.env.IMAGE_ASSETS_URL}/blog/deploy-hooks/image-03.png`}
width={581}
height={398}
/>
...
<Image
  width={3000 / 2.75}
  height={1160 / 2.75}
  src={`${process.env.IMAGE_ASSETS_URL}/blog/deploy-hooks/deploy-hooks-group.png`}
/>
