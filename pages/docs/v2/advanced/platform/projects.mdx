...
The projects structure enables faster locating of [deployments logs, source](/docs/v2/advanced/concepts/special-paths), and [aliases](/docs/v2/custom-domains#deploying-with-your-domain).
