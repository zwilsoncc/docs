...
The projects structure enables faster locating of [deployments logs](/docs/v2/advanced/platform/deployments/#logs-view), [source code](/docs/v2/advanced/platform/deployments/#source-view), and [custom domains](/docs/v2/custom-domains).
