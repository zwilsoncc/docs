...
export const meta = {
  ...
  editUrl: 'pages/docs/v2/advanced/platform/regions-and-providers.mdx',
...
In some cases, the routing layer is in a different region from where [Now Lambdas](/docs/v2/advanced/concepts/lambdas) are invoked. The roundtrip latency between them is usually in the 1 millisecond to sub-millisecond range.
