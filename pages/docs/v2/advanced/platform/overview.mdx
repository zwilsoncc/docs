...
We recommend migrating to v2 for increased performance, security and new features by following our [upgrade guide](/guides/upgrade-to-2-0).
...
If you created your account before 29-10-2018, you will be in the **1.0 legacy platform**. Otherwise, you'll always be on the **latest** (2.0 as of now). We recommend upgrading to v2 once you are confident you have [upgraded your projects](/guides/upgrade-to-2-0).
