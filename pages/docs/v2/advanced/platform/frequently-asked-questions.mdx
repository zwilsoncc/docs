...
Now CLI will automatically upgrade your deployment to the latest platform version if your project meets certain criterias. In order for this to work for your project, you must:
