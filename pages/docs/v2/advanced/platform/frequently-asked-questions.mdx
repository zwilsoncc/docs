...
If your project contains a `package.json` file and no `api` directory, it is expected to provide a `build` [script](https://docs.npmjs.com/misc/scripts) that performs a static build of your frontend and outputs it to a `public` directory at the root of your project.
...
Now CLI will automatically upgrade your deployment to the latest platform version if you create a new project or if your project meets certain criterias. In order for this to work, you must:
