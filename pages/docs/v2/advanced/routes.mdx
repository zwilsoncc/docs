...
export const meta = {
  ...
  lastEdited: '2019-08-23T13:30:21.000Z'
}
...
You can use this [online visual PCRE tester](https://regex101.com) to quickly test your `src` paths before deploying them with ZEIT Now.
