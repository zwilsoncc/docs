...
export const meta = {
  ...
  lastEdited: '2019-07-18T14:39:07.000Z'
}
...
[Import](https://import.pw) can be configured by adding options to the `import` property of the `config`. The `IMPORT_` prefix must not be set in this case:
