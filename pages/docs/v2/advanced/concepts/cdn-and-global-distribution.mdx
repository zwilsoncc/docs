...
If you do not specify a region (which can be done using the `--regions` flag in [Now CLI](/download)), your [Lambdas](/docs/v2/advanced/concepts/lambdas) will only be created in the region that is closest to you.
