...
export const meta = {
  ...
  lastEdited: '2019-09-24T20:45:27.000Z'
}
...
Within a [Directory Listing](/docs/v2/network/directory-listing/) or [source view](/docs/v2/advanced/concepts/special-paths/#source-view), built Serverless Functions (represented by the icon **λ**) show up as "files" alongside static ones.
