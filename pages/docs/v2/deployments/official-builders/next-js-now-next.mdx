...
export const meta = {
  ...
  lastEdited: '2019-06-21T04:23:32.000Z'
}
...
<Note>
  Visit to the{' '}
  <GenericLink href="https://zeit.co/docs/v2/development/environment-variables/#using-a-.env.build-file">
    now dev
  </GenericLink>{' '}
  docs for using a <InlineCode>.env.build</InlineCode> file.
</Note>
