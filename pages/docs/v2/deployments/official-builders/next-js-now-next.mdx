...
export const meta = {
  ...
  lastEdited: '2019-06-19T17:40:46.000Z'
}
...
<Caption>
  An example <InlineCode>now.json</InlineCode> file specifying a
...
<Caption>An example <InlineCode>index.js</InlineCode> file that references environment variables.</Caption>
...
<Caption>An example <InlineCode>index.js</InlineCode> file that shows the value of the referenced environment variables.</Caption>
