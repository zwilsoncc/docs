...
export const meta = {
  ...
  lastEdited: '2019-04-30T14:59:13.000Z'
}
...
<Note>
  <InlineCode>@now/go</InlineCode> will automatically detect a `go.mod` file to
  install dependencies at the entrypoint level.
</Note>
