...
The alias or aliases are applied automatically using [Now for GitHub](/docs/v2/integrations/now-for-github) or [Now for GitLab](/docs/v2/integrations/v2/integrations/now-for-gitlab) when merging or pushing to the default branch.
