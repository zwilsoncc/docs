...
export const meta = {
  ...
  lastEdited: '2019-07-02T17:39:47.000Z'
}
...
A route can be defined within a project's [`now.json` configuration file](/docs/v2/deployments/configuration/#routes) as an object within an array assigned to the `routes` property, like the following which creates a simple proxy from one path to another:
