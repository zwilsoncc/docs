...
When a deployment is created, it must [supply a `name`](/docs/v2/deployments/configuration#name). If the user doesn't explicitly provide one, Now CLI will use the directory name.
