...
export const meta = {
  ...
  description: 'A look at the concept of immutable deployments, the reasoning behind the behaviour, and the technical aspects of the implementation.'
}
...
This allows you to examine the evolution of a project over time. In addition, if a bug is detected, you can instantly roll back by changing the [alias](/docs/v2/domains-and-aliases/aliases) of your production domain.
