...
export const meta = {
  ...
  description: 'A look at what Builders are and how they are used with ZEIT Now deployment Builds to achieve production-ready outputs.'
}
...
<Caption>Using the <GenericLink href="/docs/v2/deployments/official-builders/go-now-go">@now/go Builder</GenericLink> and configuring the <InlineCode>maxLambdaSize</InlineCode> within a <GenericLink href="/docs/v2/deployments/configuration#builds">now.json configuration file</GenericLink>.</Caption>
</Example>
