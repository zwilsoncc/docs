...
export const meta = {
  ...
  lastEdited: '2019-01-13T04:20:00.000Z'
}
...
- The `build` function returns a [Files](#files-:-map<file-|-lambda>) datastructure that contains the [build outputs](/docs/v2/deployments/builds#sources-and-outputs), which can be:
  - Static files
...
This utility allows you to _scan_ the filesystem and return a `Files` representation of the matched glob search string. It can be thought of as the reverse of [`download`](#fs-download-files).
