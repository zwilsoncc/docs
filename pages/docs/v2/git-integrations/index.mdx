...
You can install any Git integration directly from your dashboard by clicking ["New Project"](/import), then from the GitHub, GitLab, or Bitbucket tabs in the "From your existing code" section, clicking the "connect" or "install" button.
