...
export const meta = {
  ...
  description: `How to use the ${PRODUCT} Git Integrations for GitHub, GitLab, or Bitbucket to automatic deploy from your project's repository for each push and ship to production on merge to the main branch.`,
  image: `${process.env.ASSETS}/docs/git-integrations/git-push.png`,
  editUrl: 'pages/docs/v2/git-integrations/index.mdx',
  lastEdited: '2020-03-04T23:42:31.000Z'
}

&#8203;<ProductName /> provides integrations for your [GitHub](/docs/v2/git-integrations/zeit-now-for-github), [GitLab](/docs/v2/git-integrations/zeit-now-for-gitlab), and [Bitbucket](/docs/v2/git-integrations/zeit-now-for-bitbucket) projects, allowing for **automatic deployments on every branch push** and merge to the default branch.
