...
Link your GitHub and ZEIT Now account from your dashboard by clicking ["Import Project"](/import) followed by ["From Git Repository"](/import/git). Then, click "Install Now for GitHub".
...
Once you have authorized the GitHub integration, you will redirect back to the "Import Git Repository" page where you can import a project from an existing repository by clicking the "Import Project from GitHub" button.
