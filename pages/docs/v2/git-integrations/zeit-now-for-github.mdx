...
Link your GitHub and ZEIT accounts from your dashboard by clicking the ["New Project"](/import) button followed by the "Install Now for GitHub" button from the "GitHub" tab under the "From your existing code" section.
