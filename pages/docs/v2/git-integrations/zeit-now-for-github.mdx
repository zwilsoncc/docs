...
export const meta = {
  ...
  lastEdited: '2020-02-27T21:01:47.000Z'
}
...
Link your GitHub and ZEIT accounts from your dashboardby clicking ["Import Project"](/import) followed by ["From Git Repository"](/import/git). Then, click "Install Now for GitHub".
...
Once you have authorized the GitHub integration, you will redirect back to the Import Project page where you can import a project from an existing repository by clicking the "Import Project from GitHub" button.
