...
export const meta = {
  title: `${PRODUCT} for GitHub`,
  description: `Deploy each change in your GitHub repositories with ${PRODUCT} to share and test with your colleagues. Instant share-able links to your work with each push. Automatically make your changes available from production domains.`,
...
Link your GitHub account with your personal account or team on <ProductName /> from your dashboard by clicking ["Import Project"](/import) followed by ["From Git Repository"](/import/git). Then, click "Install Now for GitHub".
...
### More Information About <ProductNameWrapper name={PRODUCT} /> for GitHub
