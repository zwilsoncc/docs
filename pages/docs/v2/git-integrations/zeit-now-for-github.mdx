...
export const meta = {
  ...
  lastEdited: '2020-02-24T19:26:15.000Z'
}
...
Link your GitHub and ZEIT accounts from your dashboard by clicking the ["Import Project"](/import) button followed by the "Install Now for GitHub" button from the "GitHub" tab under the "From your existing code" section.

Once you have authorized the GitHub integration, you will redirect back to the Import Project page where you can create a new project from an existing repository by clicking the "Import Project from GitHub" button under the "GitHub" tab or by selecting a template and creating a GitHub repository from it.
