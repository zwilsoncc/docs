...
Once you have authorized the GitHub integration, you will redirect back to the Import Project page where you can import a project from an existing repository by clicking the "Import Project from GitHub" button under the "GitHub" tab or by selecting a template and creating a GitHub repository from it.
