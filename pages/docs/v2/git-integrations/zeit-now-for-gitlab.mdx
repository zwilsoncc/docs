...
Get started from your dashboard by clicking the ["New Project"](/import) button followed by "Connect with GitLab" from the "GitLab" tab under "From your existing code".
