...
Get started from your dashboard by clicking the ["Import Project"](/import) button followed by "Connect with GitLab" from the "GitLab" tab under "From your existing code".
...
Once you have authorized the GitLab integration, you will redirect back to the "Import Project" page where you can create a new project from an existing repository by clicking the "Import Project from GitLab" button under the "GitLab" tab or by selecting a template and creating a GitLab repository from it.
