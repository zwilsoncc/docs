...
export const meta = {
  title: `${PRODUCT} for GitLab`,
  description: `Deploy each change in your GitLab projects with ${PRODUCT} to share and test with your colleagues. Instant share-able links to your work with each push. Automatically make your changes available from production domains.`,
...
### More Information About <ProductNameWrapper name={PRODUCT} /> for GitLab
