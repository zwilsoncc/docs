...
Once you have authorized the GitLab integration, you will redirect back to the "Import Project" page where you can import a project from an existing repository by clicking the "Import Project from GitLab" button under the "GitLab" tab or by selecting a template and creating a GitLab repository from it.
