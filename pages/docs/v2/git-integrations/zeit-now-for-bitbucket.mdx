...
Get started from your dashboard by clicking the ["New Project"](/import) button followed by "Connect with Bitbucket" from the "Bitbucket" tab under "From your existing code".
