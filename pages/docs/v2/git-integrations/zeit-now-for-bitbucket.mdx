...
export const meta = {
  title: `${PRODUCT} for Bitbucket`,
  description: `Deploy each change in your Bitbucket projects with ${PRODUCT} to share and test with your colleagues. Instant share-able links to your work with each push. Automatically make your changes available from production domains.`,
...
### More Information About <ProductNameWrapper name={PRODUCT} /> for Bitbucket
