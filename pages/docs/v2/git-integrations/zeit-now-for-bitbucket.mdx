...
Once you have authorized the Bitbucket integration, you will redirect back to the "Import Project" page where you can create a new project from an existing repository by clicking the "Import Project from Bitbucket" button under the "Bitbucket" tab or by selecting a template and creating a Bitbucket repo from it.
