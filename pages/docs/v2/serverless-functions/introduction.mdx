...
export const meta = {
  ...
  lastEdited: '2020-01-20T10:35:40.000Z'
}
...
More examples of applications you can deploy paired with Serverless Functions can be found in the [Now repository on GitHub](https://github.com/zeit/now/tree/master/examples).
