...
For an advanced configuration and structure, you can create a `now.json` file to define [Builds](/docs/v2/advanced/runtimes/overview) and other customizations.
