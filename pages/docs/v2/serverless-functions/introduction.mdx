...
<ProductName /> provides an additional command with [Now CLI](/download) to help you develop Serverless Functions locally by replicating the production environment on <ProductName /> with your localhost.
