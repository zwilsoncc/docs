...
export const meta = {
  ...
  lastEdited: '2019-08-15T11:20:24.000Z'
}
...
For an advanced configuration and structure, you can use a `now.json` file to set up [Builds](/docs/v2/advanced/builders/overview) to configure your own structure and behavior.
