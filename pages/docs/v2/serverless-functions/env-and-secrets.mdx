...
The ZEIT Now platform reserves the usage of some environment variable names by default. You can find a list of these names in the [configuration documentation](/docs/configuration#configuration/reserved-variables).
