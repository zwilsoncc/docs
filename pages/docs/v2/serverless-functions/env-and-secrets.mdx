...
export const meta = {
  ...
  lastEdited: '2019-08-15T12:18:58.000Z'
}
...
<Caption>Defining a <P.B>Now Secret</P.B> using <GenericLink href="/download">Now CLI</GenericLink>.</Caption>

To **remove a Now Secret**, use the following command:

<Snippet dark text="now secrets rm <secret-name>" />
<Caption>Removing a <P.B>Now Secret</P.B> using <GenericLink href="/download">Now CLI</GenericLink>.</Caption>

To **rename a Now Secret**, use the following command:

<Snippet dark text="now secrets rename <secret-name> <new-name>" />
<Caption>Renaming a <P.B>Now Secret</P.B> using <GenericLink href="/download">Now CLI</GenericLink>.</Caption>
...
<Note hint>
  To use environment variables at the <P.B>build step of your application</P.B>,
  refer to the{' '}
