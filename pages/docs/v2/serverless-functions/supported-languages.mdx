...
export const meta = {
  ...
  description: `Learn how to deploy Serverless Functions with ${PRODUCT}.`,
  editUrl: 'pages/docs/v2/serverless-functions/supported-languages.mdx',
  lastEdited: '2020-04-11T07:34:00.000Z'
}
...
<Card title="Introduction to <ProductName />" href="/docs/v2/introduction">
