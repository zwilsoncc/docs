...
export const meta = {
  ...
  lastEdited: '2019-11-20T16:34:53.000Z'
}
...
The Node.js version, though defaulted to **10.x**, can be changed to **12.x** by defining [engines](https://docs.npmjs.com/files/package.json#engines) in `package.json`:
...
<Caption>
  Defining the <InlineCode>12.x</InlineCode> Node.js version in a{' '}
