...
The <CdnName /> is active for all deployments and domains on your account and caches your content at [the edge](/docs/v2/network/regions-and-providers/) to serve data to your users as fast as possible.
