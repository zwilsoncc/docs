...
export const meta = {
  ...
  description: `Learn how Serverless Function responses are cached with ${PRODUCT} and how you can define the cache behavior.`,
...
The Smart CDN is available for all of our [pricing plans](/docs/v2/platform/limits#plans) (including the Hobby plan) and can be activated for [Serverless Functions](/docs/v2/serverless-functions/introduction) by providing [`Cache-Control` headers](https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/Cache-Control).
