...
<Note>
  You can automatically alias your domain to staging and production aliases in
  just a few steps:{' '}
  <GenericLink href="/docs/v2/domains-and-aliases/aliasing-a-domain">
    Aliasing a Domain Documentation
  </GenericLink>
  .
</Note>
