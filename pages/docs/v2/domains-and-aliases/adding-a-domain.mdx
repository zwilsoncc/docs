...
That's it! You're ready to [alias your deployments](/docs/v2/domains-and-aliases/aliasing-a-deployment) and [create DNS records](/docs/v2/domains-and-aliases/dns). Your wildcard certficate is created automatically.
...
If you decide later that you want to migrate to ZEIT nameservers (including as part of a [zero-downtime migration](/docs/v2/domains-and-aliases/zero-downtime-domain-migration), you can find the intended set of nameservers for your domain by running the inspect command:
