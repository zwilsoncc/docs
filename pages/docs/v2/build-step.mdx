...
export const meta = {
  ...
  lastEdited: '2020-02-25T00:24:04.000Z'
}
...
If no framework is detected, it will be specified as "Other".
...
If you’d like to override the build command, you can turn on the **Override** setting and specify the command.
...
If you’d like to use a custom command for <InlineCode>now dev</InlineCode>, you can turn on the **Override** setting. Please note the following:
