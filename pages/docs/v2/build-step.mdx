...
export const meta = {
  ...
  lastEdited: '2020-02-25T00:34:33.000Z'
}
...
- Alternatively, you can turn on the **Override** setting and leave the field empty (in which case, the build step will be skipped).
...
- If you specify a custom command, your command must pass the `$PORT` variable to your framework. For example, for [Next.js](https://nextjs.org/), you should use: `next dev --port $PORT`.
