...
export const meta = {
  ...
  lastEdited: '2020-02-23T07:34:45.000Z'
}

When you deploy on ZEIT Now, we **build** your project. For many frontend frameworks, we automatically configure the build settings, but you can also customize them. You can also use environment variables to avoid hardcoding values.
