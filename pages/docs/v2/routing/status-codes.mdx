...
export const meta = {
  ...
  lastEdited: '2019-03-29T02:01:47.000Z'
}
...
No valid **AWS Accounts** were found for the [Lambda](https://zeit.co/docs/v2/deployments/concepts/lambdas/). This is a problem with Now itself. Please reach out to us [for support](mailto:team@zeit.co) with a deployment URL so we may help resolve this error.
