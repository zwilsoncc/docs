...
To deploy with Now, you will need to install [Now CLI](/download), a frequently updated, and [open-source](https://github.com/zeit/now-cli), command-line interface.
...
<TerminalInput>npx create-next-app my-next-project</TerminalInput>
