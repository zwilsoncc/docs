...
Connect through the ["New Project"](/import) page under the "From an existing project" section, and then from the same place, set up a project using your Git integration.
