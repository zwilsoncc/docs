...
<List columnsDesktop={3} columnsTablet={3} columnsMobile={1}>
  <IconCard label="GitHub" icon={<GitHubIcon />} href="/import/git" plus />
  <IconCard label="GitLab" icon={<GitLabIcon />} href="/import/git" plus />
  <IconCard
    label="Bitbucket"
    icon={<BitbucketIcon />}
    href="/import/git"
...
Quickstarts let you get started quickly. The following quickstarts are paired with guides and a deploy button, based on the example found in the [<ProductName /> repository](https://github.com/vercel/vercel/tree/master/examples), to help you get going with your project as fast as possible.
