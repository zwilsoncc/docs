...
<Image
  ...
  height={1282/2.5}
/>
<Caption style={{marginTop: '-40px'}}>Commits pushed to Bitbucket are automatically built and deployed with ZEIT Now.</Caption>

## Set up ZEIT Now for Bitbucket

### Step 1: Link ZEIT Now to Your Bitbucket Account

You can connect your ZEIT Now account to Bitbucket by visiting your [account or team](/docs/v2/platform/users-and-teams) [settings page](/account) and clicking the "Connect with Bitbucket" button.
...
Next, you will need to authorize the ZEIT Now application on Bitbucket with your account.
...
Alternatively; if you do not already have a ZEIT Now account, you can sign up to ZEIT using your Bitbucket account from [the sign up page](/signup).
