...
To use the Deploy to <ProductNameShort /> button with HTML, add the button as an image and wrap it with a link to the endpoint, changing only the template parameter:
