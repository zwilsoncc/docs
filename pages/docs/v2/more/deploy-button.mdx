...
The example below shows how the deploy button looks when rendered, clicking it allows you to deploy the [Gatsby example](https://github.com/zeit/now/tree/master/examples/gatsby) from the [Now repository](https://github.com/zeit/now/tree/master/examples).
