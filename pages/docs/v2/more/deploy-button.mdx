...
The example below shows how the deploy button looks when rendered, clicking it allows you to deploy our [Gatsby example](https://github.com/vercel/vercel/tree/master/examples/gatsby).

<Link href="/import/project?template=https://github.com/vercel/vercel/tree/master/examples/gatsby">
...
<Snippet dark text="https://vercel.com/import/project?template=https://github.com/vercel/vercel/tree/master/examples/gatsby" />
...
```
[![Deploy to Vercel](/button)](/import/project?template=https://github.com/vercel/vercel/tree/master/examples/gatsby)
```
...
```html
<a
  href="/import/project?template=https://github.com/vercel/vercel/tree/master/examples/gatsby"
>
