...
To create a Deploy Hook, the first thing you need to do is to install [ZEIT Now for GitHub](/docs/v2/more/now-for-github), [ZEIT Now for GitLab](/docs/v2/more/now-for-gitlab), or [ZEIT Now for Bitbucket](/docs/v2/more/now-for-bitbucket). This allows you to link a ZEIT project to a new or existing Git repository.
