...
export const meta = {
  ...
  lastEdited: '2020-03-05T04:46:02.000Z'
}
...
Once your project is connected, navigate to its "Settings" page and you will see a section called "Deploy Hooks". Here, choose a name for your Deploy Hook and select the branch that will be deployed when the generated URL is requested.
...
<Note>
  ...
  be able to understand when it triggers a deployment. We also suggest creating only
