...
- Instant rollbacks when reverting changes that have been already been aliased.
...
You can connect the your Now account to GitLab by visiting your [account or team](/docs/v2/platform/users-and-teams) [settings page](/account) and clicking the "Connect with GitLab" button.
...
Alternatively; if you have not already got a Now account, you can sign up to ZEIT using your GitLab account from [the sign up page](/signup).
...
Using [a `now.json` file](/docs/v2/deployments/configuration), you can configure your projects to deploy as dynamic serverless functions.
