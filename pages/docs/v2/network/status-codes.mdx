...
Type: <GenericLink href="/docs/error/platform/DEPLOYMENT_NOT_READY_REDIRECTING">`DEPLOYMENT_NOT_READY_REDIRECTING`</GenericLink>

Deployment not ready, redirecting to inspector.

### 402

Type: <GenericLink href="/docs/error/application/DEPLOYMENT_BLOCKED">`DEPLOYMENT_BLOCKED`</GenericLink>

Your subscription was blocked.

### 404

Type: <GenericLink href="/docs/error/application/RESOURCE_NOT_FOUND">`RESOURCE_NOT_FOUND`</GenericLink>
...
<Note>
  ...
  <GenericLink href="/docs/configuration#routes/advanced/custom-404">
...
Type: <GenericLink href="/docs/error/platform/DEPLOYMENT_NOT_FOUND">`DEPLOYMENT_NOT_FOUND`</GenericLink>

The deployment you tried to access does not exist.

### 405

Type: <GenericLink href="/docs/error/application/INVALID_REQUEST_METHOD">`INVALID_REQUEST_METHOD`</GenericLink>

The static file responsible for the path you tried can only accept `GET` or `HEAD` requests.

### 413

Type: <GenericLink href="/docs/error/application/FUNCTION_PAYLOAD_TOO_LARGE">`FUNCTION_PAYLOAD_TOO_LARGE`</GenericLink>

The request's body is too large for invoking the <b>Serverless Function</b>.

### 500

Type: <GenericLink href="/docs/error/platform/INTERNAL_FUNCTION_NOT_FOUND">`INTERNAL_FUNCTION_NOT_FOUND`</GenericLink>

We were not able to locate the <b>Serverless Function</b> responsible for the path you tried to access.

### 500

Type: <GenericLink href="/docs/error/platform/INTERNAL_INVALID_FUNCTION_REGION">`INTERNAL_INVALID_FUNCTION_REGION`</GenericLink>

No <b>Serverless Function</b> was found in the region identifier attached to the deployment.

### 500

Type: <GenericLink href="/docs/error/platform/INTERNAL_INVALID_FUNCTION_ACCOUNTS">`INTERNAL_INVALID_FUNCTION_ACCOUNTS`</GenericLink>
...
Type: <GenericLink href="/docs/error/platform/INTERNAL_FUNCTION_INVOCATION_FAILED">`INTERNAL_FUNCTION_INVOCATION_FAILED`</GenericLink>

The <b>Network layer</b> was not able to invoke the <b>Serverless Function</b>.

### 502

Type: <GenericLink href="/docs/error/application/NO_STATUS_CODE_FROM_FUNCTION">`NO_STATUS_CODE_FROM_FUNCTION`</GenericLink>

The <b>Serverless Function</b> responsible for the path you tried to access did not reply with a status code.

### 502

Type: <GenericLink href="/docs/error/application/BODY_NOT_A_STRING_FROM_FUNCTION">`BODY_NOT_A_STRING_FROM_FUNCTION`</GenericLink>

The <b>Serverless Function</b> responsible for the path you tried to access replied with a non-string body.

### 504

Type: <GenericLink href="/docs/error/platform/FUNCTION_INVOCATION_TIMEOUT">`FUNCTION_INVOCATION_TIMEOUT`</GenericLink>
...
Type: <GenericLink href="/docs/error/application/INFINITE_LOOP_DETECTED">`INFINITE_LOOP_DETECTED`</GenericLink>
