...
export const meta = {
  ...
  description: `A listing and explanation of the regions and providers ${PRODUCT} implements.`,
...
| Region ID | Reference Location        | Provider Region (Routing)   | Provider Region (<ProductNameShort /> Serverless Functions) | Origin/Edge |
| --------- | ------------------------- | --------------------------- | ----------------------------------------------------------- | ----------- |
