...
export const meta = {
  ...
  lastEdited: '2019-08-27T08:44:34.000Z'
}
...
An Origin Region is a Region where content originates, whereas an Edge Region can _only_ serve cached or static content. An application should generally only deploy to the Origin Regions closest to the Regions where the data is stored.
