...
The ZEIT Network layer sits in-between the internet and your Now deployments. This type of network topology is sometimes called a [Content Delivery Network](https://en.wikipedia.org/wiki/Content_delivery_network) or CDN.
...
In order to route requests as fast as possible, the Network layer is running in dozens of locations across the world. In all of these locations (called **Regions**), you can create **Deployments** that create [Builds](/docs/v2/advanced/runtimes/) outputting **[Serverless Functions](/docs/v2/serverless-functions/introduction/)** and/or **Static Files.** The full list of regions can be found [here](/docs/v2/platform/regions-and-providers/).
