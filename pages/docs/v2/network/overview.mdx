...
export const meta = {
  ...
  description: `The ${ORG_NAME} Network layer sits in-between the internet and your deployments. It routes the users requests to the correct files of the requested deployment.`,
