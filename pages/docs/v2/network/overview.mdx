...
In order to route requests as fast as possible, the Network layer is running in dozens of locations across the world. In all of these locations (called **Regions**), you can create **Deployments** that create [Builds](/docs/v2/advanced/builders/) outputting **[Serverless Functions](/docs/v2/advanced/concepts/serverless-functions/)** and/or **Static Files.** The full list of regions can be found [here](/docs/v2/platform/regions-and-providers/).
