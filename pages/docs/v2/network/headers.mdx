...
| <RequestHeader>MISS</RequestHeader>   | The response was not found in the edge and so was fetched from [an origin server](/docs/v2/advanced/platform/regions-and-providers/).            |
...
Contains a list of [our data centers](/docs/v2/advanced/platform/regions-and-providers/) through which the request has traversed, usually the data center closest to you.
