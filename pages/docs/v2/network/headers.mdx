...
export const meta = {
  title: 'Headers',
  description: `The list of headers included with deployments with ${PRODUCT}.`,
...
This header's value indicates whether the response was served from <ProductNameSimple />'s edge cache.
