...
Custom headers can be added dynamically to the [Response](https://nodejs.org/api/http.html#http_response_setheader_name_value) object in your [Serverless Function](/docs/v2/advanced/concepts/serverless-functions/) or they can be added statically to the [Routes](/docs/configuration#routes/headers) property in your `now.json` file.
