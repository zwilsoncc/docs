...
export const meta = {
  ...
  lastEdited: '2019-07-22T17:59:57.000Z'
}
...
If you would like to hide the **Directory Listing** for a certain path, you can do so using the following method.

## Include an Index File

As mentioned above, the **Directory Listing** will only occur if there is no **Index File** at the path the client is trying to access.
