...
export const meta = {
  ...
  lastEdited: '2020-02-05T23:43:02.000Z'
}

Our [Smart CDN](/smart-cdn) caches your content at the edge in order to serve data to your users as fast as possible.

**Asset caching is automatic for all deployments.** This means that no changes need to be made to headers. You get the best performance possible out of the box with zero configuration required.
