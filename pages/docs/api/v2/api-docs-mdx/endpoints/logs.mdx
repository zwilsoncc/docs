...
export const meta = {
  ...
  lastEdited: '2019-11-18T14:26:29.000Z'
}
...
| **limit**     | <HelpLink href="#api-basics/types">Number</HelpLink>       | Maximum event count to return. `-1` to return all available logs                 |
| **types**     | <HelpLink href="#api-basics/types">List</HelpLink>         | The type of log. The type could be `request`, `response`, `command` or `stdout`. |
| **since**     | <HelpLink href="#api-basics/types">Number</HelpLink>       | Beginning timestamp for build logs                                               |
| **until**     | <HelpLink href="#api-basics/types">Number</HelpLink>       | Ending timestamp for build logs                                                  |
| **direction** | <HelpLink href="#api-basics/types">Enum</HelpLink>         | Direction in which logs would be rerturned. Can be `backward` or `forward`       |
...
Open a HTTP stream of realtime logs for a Serverless Function by it's name.
