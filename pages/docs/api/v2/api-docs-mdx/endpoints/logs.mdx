...
<OutputTable>
  ...
  <Row>
    ...
    <Cell>The type of log. The type could be <InlineCode>request</InlineCode>, <InlineCode>response</InlineCode>, <InlineCode>command</InlineCode> or <InlineCode>stdout</InlineCode>.</Cell>
  </Row>
  <Row>
  ...
  <Row>
    ...
    <TypeCell>Enum</TypeCell>
    <Cell>The name of the region where the instance was running. The region could be any supported region, for example; <InlineCode>sfo</InlineCode>.</Cell>
  </Row>
</OutputTable>
...
<OutputTable>
  ...
  <Row>
    ...
    <TypeCell>String</TypeCell>
    <Cell>The number of bytes sent in the body of the response.</Cell>
  </Row>
  <Row>
...
<Table head={
  ...
  <Row>
    ...
    <Cell>The log is an HTTP request.</Cell>
  </Row>
  <Row>
    <BoldCell>response</BoldCell>
    <Cell>The log is an HTTP response.</Cell>
  </Row>
  <Row>
