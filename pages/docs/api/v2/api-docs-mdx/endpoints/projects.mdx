...
export const meta = {
  ...
  lastEdited: '2019-04-21T20:50:50.000Z'
}
...
Create a set of new environment variables for the project by passing the project `id` in the URL and an `env` map as a request parameter.
