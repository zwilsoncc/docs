...
<Endpoint method="POST" url="/v10/now/deployments" />
...
<Request
  url="https://api.zeit.co/v10/now/deployments"
  method="POST"
  headers={{
...
<Request
  method="POST"
  url="https://api.zeit.co/v10/now/deployments?forceNew=1"
  headers={{
    'Content-Type': 'application/json'
  }}
  auth
...
<Endpoint>
  GET /v10/now/deployments/:id
  <br />
  GET /v10/now/deployments/get?url=[deployment URL or alias]
</Endpoint>
...
<Request
  method="GET"
  url="https://api.zeit.co/v10/now/deployments/dpl_89qyp1cskzkLrVicDaZoDbjyHuDJ"
  auth
/>
...
<Endpoint>
  DELETE /v10/now/deployments/:id
  <br />
  DELETE /v10/now/deployments/remove?url
</Endpoint>
...
<Request
  method="DELETE"
  url="https://api.zeit.co/v10/now/deployments/dpl_5WJWYSyB7BpgTj3EuwF37WMRBXBtPQ2iTMJHJBJyRfd"
  auth
/>
...
<Endpoint method="GET" url="/v10/now/deployments/:id/files" />
...
<Request
  url="https://api.zeit.co/v10/now/deployments/dpl_BRGyoU2Jzzwx7myBnqv3xjRDD2GnHTwUWyFybnrUvjDD/files"
  auth
/>
...
<Endpoint method="GET" url="/v10/now/deployments/:id/files/:fileId" />
...
<Request
  url="https://api.zeit.co/v10/now/deployments/dpl_BRGyoU2Jzzwx7myBnqv3xjRDD2GnHTwUWyFybnrUvjDD/files/2d4aad419917f15b1146e9e03ddc9bb31747e4d0"
  auth
/>
...
<Endpoint method="GET" url="/v10/now/deployments/:id/builds" />
...
<Request
  url="https://api.zeit.co/v10/now/deployments/dpl_BRGyoU2Jzzwx7myBnqv3xjRDD2GnHTwUWyFybnrUvjDD/builds"
  auth
/>
