...
export const meta = {
  ...
  lastEdited: '2019-03-22T01:46:12.000Z'
}
...
<Endpoint method="POST" url="/v8/now/deployments" />
...
<Request
  url="https://api.zeit.co/v8/now/deployments"
  method="POST"
  headers={{
...
<Request
  method="POST"
  url="https://api.zeit.co/v8/now/deployments?forceNew=1"
  headers={{
    'Content-Type': 'application/json'
  }}
  auth
...
<Endpoint method="GET" url="/v8/now/deployments/:id" />
...
| **aliasFinal** | <HelpLink href="#api-basics/types">List</HelpLink>         | A list of all the aliases (default aliases, staging aliases and production aliases) that were assigned upon deployment creation.                                                                          |

<Example>
<PDIV>Example Request:</PDIV>
<Request
  method="GET"
  url="https://api.zeit.co/v8/now/deployments/dpl_89qyp1cskzkLrVicDaZoDbjyHuDJ"
  auth
/>
...
<Endpoint method="DELETE" url="/v8/now/deployments/:id" />
...
<Request
  url="https://api.zeit.co/v8/now/deployments/dpl_BRGyoU2Jzzwx7myBnqv3xjRDD2GnHTwUWyFybnrUvjDD/files/2d4aad419917f15b1146e9e03ddc9bb31747e4d0"
  auth
/>
...
<Example>
  <span>Example Request:</span>
  <Request
    url="https://api.zeit.co/v8/now/deployments/dpl_BRGyoU2Jzzwx7myBnqv3xjRDD2GnHTwUWyFybnrUvjDD/builds"
    auth
  />
  <span>
    Example Successful (<P.B>200</P.B>) response:
