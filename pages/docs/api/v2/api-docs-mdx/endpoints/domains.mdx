...
<OutputTable>
  ...
  <Row>
    ...
    <Cell>If it is an <GenericLink href="/docs/getting-started/assign-a-domain-name#4.-using-a-custom-domain-with-a-cname">externally handled domain</GenericLink></Cell>
  </Row>
  <Row>
  ...
  <Row>
    ...
    <TypeCell>List</TypeCell>
    <Cell>The list domains or subdomains with an SSL certificated provisioned.</Cell>
  </Row>
</OutputTable>
...
<InputTable>
  ...
  <Row>
    ...
    <Cell><InlineCode>external</InlineCode> for <GenericLink href="/docs/features/dns#adding-a-domain-using-external-nameservers">externally handled domains</GenericLink>; <InlineCode>zeit.world</InlineCode> for managed.</Cell>
  </Row>
</InputTable>
...
<OutputTable>
  ...
  <Row>
    ...
    <TypeCell>String</TypeCell>
    <Cell>The <GenericLink href="/docs/features/dns#adding-a-domain-using-external-nameservers">token</GenericLink> required to verify the ownership of an external domain.</Cell>
  </Row>
  <Row>
