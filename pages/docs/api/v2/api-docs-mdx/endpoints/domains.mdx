...
| **aliases** | <HelpLink href="#api-basics/types">List</HelpLink> | The list of aliases using the domain. |
| **certs** | <HelpLink href="#api-basics/types">List</HelpLink> | The list domains or subdomains with an SSL certificated provisioned. |
