...
export const meta = {
  editUrl: 'pages/docs/api/v1/api-docs-mdx/endpoints/logs.mdx',
  lastEdited: '2019-01-14T17:04:19.000Z'
}
...
<OutputTable>
  ...
  <Row>
    ...
    <Cell>
      The type of log, it could be <InlineCode>request</InlineCode>,{' '}
      <InlineCode>response</InlineCode>, <InlineCode>command</InlineCode> or{' '}
      <InlineCode>stdout</InlineCode>.
    </Cell>
  </Row>
  <Row>
  ...
  <Row>
    ...
    <TypeCell>Enum</TypeCell>
    <Cell>
      The name of the region where the instance was running. It could be{' '}
      <InlineCode>now-sfo</InlineCode>.
    </Cell>
  </Row>
</OutputTable>
...
<OutputTable>
  ...
  <Row>
    ...
    <Cell>
      A valid{' '}
      <ExternalLink href="https://en.wikipedia.org/wiki/List_of_HTTP_status_codes">
        HTTP status code
      </ExternalLink>
      .
    </Cell>
...
>
  ...
  <Row>
    ...
    <Cell>
      The log is a terminal command, e.g. <InlineCode>npm start</InlineCode>.
    </Cell>
  </Row>
  <Row>
