...
<InputTable>
  ...
  <Row>
    ...
    <Cell>
      ...
      <GenericLink href="https://zeit.co/account/tokens">
...
<OutputTable>
  ...
  <Row>
    ...
    <Cell>
      ...
      be displayed to the user so he can verify the request is the correct.
    </Cell>
  </Row>
</OutputTable>
...
<OutputTable>
  <Row>
    ...
    <Cell>
      ...
      <GenericLink href="#api-basics/authentication">
