...
export const meta = {
  ...
  lastEdited: '2019-04-21T15:00:50.000Z'
}
...
You will need to register your app before getting started, you can do this by visiting your [integrations dashboard](/dashboard/integrations).
