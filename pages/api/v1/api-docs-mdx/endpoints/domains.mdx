...
<InputTable>
  ...
  <Row>
    ...
    <Cell><InlineCode>external</InlineCode> for <GenericLink href="/docs/features/dns#adding-a-domain-using-external-nameservers">externally handled domain</GenericLink>; <InlineCode>zeit.world</InlineCode> for managed.</Cell>
  </Row>
</InputTable>
