...
export const meta = {
  title: `Deploy Svelte with ${PRODUCT}`,
  description: `Create a Svelte app and deploy it live with ${PRODUCT}.`,
  name: 'Svelte',
  type: 'app',
...
## Step 2: Deploying Your Svelte App with <ProductNameWrapper name={PRODUCT} />
