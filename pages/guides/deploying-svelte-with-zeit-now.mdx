...
export const meta = {
  ...
  lastEdited: '2019-10-30T17:18:03.000Z'
}

[Svelte](https://svelte.dev/) is a radically new approach to building user interfaces.

Create and deploy a new Svelte app with ZEIT Now without the setup using the button below.

<a href="https://zeit.co/new/project?template=https://github.com/zeit/now-examples/tree/master/svelte">
  <Image src="https://zeit.co/button" width={104} height={36} align="left" />
</a>

Alternatively, set up a Svelte app locally and deploy using Now CLI with the following steps.
...
<Caption>Initializing a Svelte app with <GenericLink href="https://www.npmjs.com/package/npx">npx</GenericLink> and moving into the project directory.</Caption>
