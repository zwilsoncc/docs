...
Create a [Secret](/docs/cli#commands/secrets) to store the access key received, this will be used later when accessing the database.
...
Create a `vercel.json` at the root of the project directory, this is used to make the [Secret](/docs/cli#commands/secrets) defined in [step 2](#step-2:-create-an-access-key) available to the Serverless Function.
