...
export const meta = {
  ...
  authors: ['danieltodonnell', 'mcsdev'],
...
<Snippet dark text="vercel secrets add FAUNADB_SECRET_KEY [your-access-key]" />
<Caption>
...
Create a `vercel.json` at the root of the project directory, this is used to make the [Secret](/docs/now-cli#commands/secrets) defined in [step 2](#step-2:-create-an-access-key) available to the Serverless Function.
...
<Caption>
  An example <InlineCode>vercel.json</InlineCode> file that makes a{' '}
