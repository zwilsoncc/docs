...
export const meta = {
  ...
  lastEdited: '2019-08-19T10:49:15.000Z'
}
...
<Snippet dark text="yarn add serverless-mysql sql-template-strings" />
<Caption>
...
<Snippet dark text="yarn add isomorphic-unfetch next react react-dom" />
<Caption>
