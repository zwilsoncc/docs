...
You now have a **complete app** with both an API and interface, the next section will show you how to deploy it seamlessly with [ZEIT Now](/docs/v2/getting-started/introduction-to-now).

## Step 6: Deploy Your Project with ZEIT Now

Getting your project ready to [deploy](/docs/v2/deployments/basics/) with [ZEIT Now](/docs/v2/getting-started/introduction-to-now) could hardly be simpler, all that's required is the inclusion of [environment variables](/docs/v2/deployments/environment-variables-and-secrets).
...
[ZEIT Now](/docs/v2/getting-started/introduction-to-now) allows you to [deploy your project](/docs/v2/deployments/basics) from the terminal with **a single command**:
