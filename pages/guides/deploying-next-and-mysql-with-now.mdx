...
export const meta = {
  title: `Create a Next.js App with a MySQL Database That Builds and Deploys with ${PRODUCT}`,
  description: `Deploy your Next.js and MySQL app with ${PRODUCT} in a serverless environment.`,
...
Now, add your database credentials from [step 1](#step-1:-populating-your-mysql-database) to the project as [secrets](/docs/v2/serverless-functions/env-and-secrets) using the [<ProductNameShort /> CLI](/download#now-cli) to keep them secure:
...
## Step 6: Deploy Your Project with <ProductNameWrapper name={PRODUCT} />
