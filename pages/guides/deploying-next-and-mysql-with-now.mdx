...
Getting your project ready to [deploy](/docs/v2/introduction) with [<ProductName />](https://zeit.co) could hardly be simpler, all that's required is the inclusion of [Environment Variables](/docs/v2/build-step#environment-variables).
