...
[ZEIT Now](https://zeit.co) allows you to [deploy your project](/docs/v2/deployments/basics) from the terminal with **a single command**:
...
You will see a short build step in your terminal followed by the news that your project has been [deployed](docs/v2/introduction), it should look similar to this: <https://next-mysql.now.sh/>
