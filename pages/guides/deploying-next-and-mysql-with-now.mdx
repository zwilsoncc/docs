...
Now you have a reusable database connection, perfectly suited for a [serverless](/docs/v2/advanced/concepts/serverless-functions/) environment.
...
That is all the API code required to successfully use pagination in a [serverless](/docs/v2/advanced/concepts/serverless-functions/) environment.
