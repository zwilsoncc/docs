...
Now, add your database credentials from [step 1](#step-1:-populating-your-mysql-database) to the project as [Secrets](/docs/now-cli#commands/secrets) using the [Now CLI](/download#now-cli) to keep them secure:
