...
export const meta = {
  title: `Deploy Scully with ${PRODUCT}`,
  description: `Create a Scully app and deploy it live with ${PRODUCT}.`,
...
## Step 2: Deploying Your Scully App with <ProductNameWrapper name={PRODUCT} />
