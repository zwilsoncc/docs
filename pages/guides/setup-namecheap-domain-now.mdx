...
<Image
  src="https://res.cloudinary.com/unicodeveloper/image/upload/v1550069781/add-domain-withnowcli.png"
  width={1852/2}
  height={1182/2}
  oversize
/>
...
<Image
  src="https://res.cloudinary.com/unicodeveloper/image/upload/v1550070201/inspect-domain.png"
  width={1852/2}
  height={1648/2}
  oversize
/>
...
<Image
  src="https://res.cloudinary.com/unicodeveloper/image/upload/c_scale,w_2396/v1549982415/domain-list.png"
  width={2396/2}
  height={1629/2}
  oversize
/>
...
<Image
  src="https://res.cloudinary.com/unicodeveloper/image/upload/c_scale,w_2396/v1549982590/custom-nameservers.png"
  width={2396/2}
  height={1629/2}
  oversize
/>
...
<Image
  src="https://res.cloudinary.com/unicodeveloper/image/upload/c_scale,w_2396/v1549985663/txtrecord.png"
  width={2396/2}
  height={1629/2}
  oversize
/>
...
If you are new to deploying with Now, follow the [Deployment Basics](https://zeit.co/docs/v2/deployments/basics/) guide to get started.
...
We highly recommend using the [Now for GitHub app](https://zeit.co/docs/v2/integrations/now-for-github/) coupled with the [`alias` configuration option](https://zeit.co/docs/v2/deployments/configuration/#alias) which will allow your application to be deployed on push to your GitHub repository and aliased automatically when merged to the main branch.
