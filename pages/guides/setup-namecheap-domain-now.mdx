...
First, you need to add your Namecheap registered domain to your <OrgName /> account. To get started, use the [Now CLI](/docs/v2/getting-started/installation#now-cli):

<Snippet dark text="now domains add <domain>" />

The command above adds the domain to your <OrgName /> account. Once it has been added, the [Now CLI](/docs/v2/getting-started/installation#now-cli) outputs some information needed to verify ownership of the domain.
