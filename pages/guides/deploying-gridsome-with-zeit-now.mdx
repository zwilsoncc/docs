...
export const meta = {
  title: `Deploy Gridsome Sites with ${PRODUCT}`,
  description: `Create your Gridsome site and deploy it with ${PRODUCT}.`,
  ...
  image: `https://og-image.now.sh/**Deploying%20Gridsome%20Sites**%20%3Cbr%3E%20with%20${PRODUCT}.png?theme=light&md=1&fontSize=100px&images=https%3A%2F%2Fassets.zeit.co%2Fimage%2Fupload%2Ffront%2Fassets%2Fdesign%2Fzeit-black-triangle.svg&images=https%3A%2F%2Fgridsome.org%2Flogos%2Fonly-logo.svg&widths=auto&widths=auto`,
...
## Step 2: Deploying Your Gridsome Project with <ProductNameWrapper name={PRODUCT} />
