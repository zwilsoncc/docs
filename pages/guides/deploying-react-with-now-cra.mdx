...
export const meta = {
  ...
  description:
    `Create your Create React App project and deploy it with ${PRODUCT}.`,
  name: 'React',
  type: 'app',
  ...
  image:
    `https://og-image.now.sh/**Deploying%20React%20Apps**%20%3Cbr%20%2F%3E%20with%20${PRODUCT}.png?theme=light&md=1&fontSize=100px&images=https%3A%2F%2Fassets.zeit.co%2Fimage%2Fupload%2Ffront%2Fassets%2Fdesign%2Fzeit-black-triangle.svg&images=https%3A%2F%2Fcdn.svgporn.com%2Flogos%2Freact.svg&widths=250&widths=300&heights=250&heights=300`,
...
## Step 2: Deploying Your React Project with <ProductName/>
