...
export const meta = {
  ...
  lastEdited: '2019-08-20T13:48:36.000Z'
}
...
<Snippet dark text="yarn create next-app my-next-app && cd my-next-app" />
<Caption>
  Initializing a Next.js project with <InlineCode>create-next-app</InlineCode>{' '}
  and <GenericLink href="https://yarnpkg.com">Yarn</GenericLink>, the moving into the project directory.
</Caption>
