...
export const meta = {
  ...
  lastEdited: '2019-07-17T11:11:00.000Z'
}
...
- [Next.js + Go](https://github.com/zeit/now-examples/tree/master/nextjs-go)
- [Next.js + Node.js](https://github.com/zeit/now-examples/tree/master/nextjs-node)
- [Next.js + Node.js (TypeScript)](https://github.com/zeit/now-examples/tree/master/nextjs-node-typescript)
- [Next.js + PHP](https://github.com/zeit/now-examples/tree/master/nextjs-php)
- [Next.js + Python](https://github.com/zeit/now-examples/tree/master/nextjs-python)
- [Next.js + Ruby](https://github.com/zeit/now-examples/tree/master/nextjs-ruby)
- [Next.js + Rust](https://github.com/zeit/now-examples/tree/master/nextjs-rust)

These examples show how Next.js can be used with Now, backed by a variety of API's using different languages.
