...
By including the `with-graphql-faunadb` argument, `create-next-app` bootstraps an app based off of a template found in the [Next.js examples repository](https://github.com/vercel/next.js/tree/canary/examples).
