...
If you want your app to deploy automatically, you can install either the [ZEIT Now for GitHub](/docs/v2/more/now-for-github), [ZEIT Now for GitLab](/docs/v2/more/now-for-gitlab), or [ZEIT Now for Bitbucket](/docs/v2/more/now-for-bitbucket) apps, this will provide you with unique deployments for your Git repository on every push.
