...
export const meta = {
  title: `Create an Angular App That Builds and Deploys with ${PRODUCT}`,
  description: `Deploy your Angular app with ${PRODUCT}.`,
...
## Step 2: Deploy Your Angular Project with <ProductNameWrapper name={PRODUCT} />
