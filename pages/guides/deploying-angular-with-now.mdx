...
In this guide, we will show you how to deploy an Angular application with [ZEIT Now](/docs/v2).
...
When your app is deployed, you will receive a deployment URL like the following: https://tour-of-heroes-he3j9k80n.now.sh/
