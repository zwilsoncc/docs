...
export const meta = {
  ...
  lastEdited: '2019-09-25T20:27:19.000Z'
}
...
Create and deploy a new Angular project with ZEIT Now without the setup using the button below.

<a href="https://zeit.co/new/project?template=https://github.com/zeit/now-examples/tree/master/angular">
  <Image src="https://zeit.co/button" width={104} height={36} />
</a>
...
<Caption>Installing Angular CLI global to the system user with <GenericLink href="https://www.npmjs.com/package/@angular/cli">npm</GenericLink>.</Caption>
