...
export const meta = {
  ...
  lastEdited: '2020-02-26T01:19:50.000Z'
}
...
Next, [setup a ZEIT Now for Git integration](/docs/v2/git-integrations) to deploy your projects automatically on each push, and add a [custom domain](/docs/v2/custom-domains) to deploy your projects to.
