...
When a path is requested, the Serverless Function for that path is [invoked](/docs/v2/advanced/concepts/serverless-functions). This avoids the whole app from having to wait and watch for requests, saving on time and resources.
