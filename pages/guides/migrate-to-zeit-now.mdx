...
In serverful monolith style apps, routing is commonly handled by a single file. Inside of that file, all routes are declared, providing a single point of failure. Let's look at an Express.js example to illustrate this:
