...
export const meta = {
  ...
  description: `Migrate your websites and APIs to the ${PRODUCT} Platform with zero configuration.`,
  ...
  lastEdited: '2020-04-12T01:28:38.000Z'
}
...
### Moving to <ProductNameWrapper name={PRODUCT} /> and Serverless
