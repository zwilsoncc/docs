...
export const meta = {
  title: `Deploy Aurelia with ${PRODUCT}`,
  description: `Create an Aurelia app and deploy it live with ${PRODUCT}.`,
  published: '2019-11-01T12:00:00.860Z',
  authors: ['msweeneydev'],
  url: '/guides/deploying-aurelia-with-zeit-now',
  demo: 'https://aurelia.now-examples.now.sh',
  image: `https://og-image.now.sh/**Deploy%20Aurelia%20Apps**%20%3Cbr%2F%3E%20with%20${PRODUCT}.png?theme=light&md=1&fontSize=100px&images=https%3A%2F%2Fassets.zeit.co%2Fimage%2Fupload%2Ffront%2Fassets%2Fdesign%2Fzeit-black-triangle.svg&images=https%3A%2F%2Fcdn.svgporn.com%2Flogos%2Faurelia.svg&widths=300&widths=300&heights=300&heights=300`,
...
## Step 2: Deploying Your Aurelia App with <ProductNameWrapper name={PRODUCT} />
