...
export const meta = {
  title: 'Error Reports for Your Projects with URIports and ZEIT Now',
  description:
    'Enable error reporting for your websites deployed with ZEIT Now and act fast on issues.',
  published: '2020-02-27T14:20:44.265Z',
  authors: ['timothy'],
  image:
    'https://og-image.now.sh/**Error%20Reports**%20for%20Your%20Projects%20with%20URIports%20and%20ZEIT%20Now.png?theme=light&md=1&fontSize=90px&images=https%3A%2F%2Fassets.zeit.co%2Fimage%2Fupload%2Ffront%2Fassets%2Fdesign%2Fzeit-black-triangle.svg&images=https%3A%2F%2Fzeit.co%2Fdocs%2Fstatic%2Fguides%2Fclient-side-error-reports-with-uriports-zeit-now%2Flogo.svg',
  url: '/guides/client-side-error-reports-with-uriports-zeit-now',
  editUrl: 'pages/guides/client-side-error-reports-with-uriports-zeit-now.mdx',
  lastEdited: '2020-02-28T11:56:15.000Z'
}
...
[URIports](https://uriports.com) makes these reports free and easy to set up. You will only need to add configure a few HTTP headers to start receiving reports.

<Image
  src={`${
    process.env.ASSETS
  }/guides/client-side-error-reports-with-uriports-zeit-now/uriports.png`}
  width={2192 / 2.25}
  height={1312 / 2.25}
  oversize
  shadow
...
Firstly, [signup for a free ZEIT account](/signup), then using your project's Git repository, import and deploy your project:

<DeploySection meta={meta} />

Alternatively, you can learn about setting up your project on ZEIT Now or use one of our many Quickstarts from [the ZEIT Now introduction documentation](/docs).
