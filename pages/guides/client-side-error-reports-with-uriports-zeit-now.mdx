...
## Step 1: Setting up a project on <ProductNameWrapper name={PRODUCT} />
...
Firstly, [signup for a free <ProductNameSimple /> account](/signup), then using your project's Git repository, import and deploy your project:
...
Alternatively, run `now --prod` with <ProductNameShort /> CLI from your project's root.
