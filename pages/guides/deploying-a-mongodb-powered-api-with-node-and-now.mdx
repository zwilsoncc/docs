...
export const meta = {
  title: 'Create a Node.js API Powered by MongoDB and Deploy with Now',
  description:
  ...
  lastEdited: '2019-05-22T00:26:04.760Z'
}
...
<Note hint>
  You can skip this next section of adding your connection string as a secret
  manually by using{' '}
  <GenericLink href="/integrations/mongodb-atlas">
    the MongoDB Atlas Integration for Now
  </GenericLink>
  , which provides the connection string for a cluster automatically to your projects!
</Note>
...
<Note>
  ...
  , you can install it via <GenericLink href="/download">
    Now Desktop
  </GenericLink>, which is the easiest way to get started with Now. Alternatively,
  you can install Now CLI with Yarn using the following in your terminal: <InlineCode>
    yarn global add now
  </InlineCode>.
</Note>
...
You can view the alias and deployment, using the API path, here: https://my-mongodb-api.now.sh/api/users.js
