...
- The platform version the project uses is [ZEIT Now 2.0](/docs/v2/platform/overview/#versioning)
...
To use your domain for [production deployments](/docs/v2/custom-domains#deploying-with-your-domain), [add a custom domain](https://zeit.co/docs/v2/custom-domains/#adding-a-domain) to your project.

Now, deploy your project to a production environment using the following command:

<Snippet dark text="now --prod" />
<Caption>Deploying to production with ZEIT Now.</Caption>

<Note>
  For optimal performance,{' '}
  <Link href="/docs/configuration#project/regions">
    deploy your API to the closest region, or regions
  </Link>
  , of where your MongoDB cluster is located in. You can see the regions ZEIT Now
  supports in the <Link href="/docs/v2/platform/regions-and-providers">
...
Instead of deploying manually through your terminal, you can also get **automatic deployments with each git push** when you use [ZEIT Now for GitHub](/github), [ZEIT Now for GitLab](/gitlab), or [ZEIT Now for Bitbucket](/bitbucket).
