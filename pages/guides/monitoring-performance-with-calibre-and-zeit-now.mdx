...
export const meta = {
  title: `Monitor Performance with Calibre and ${PRODUCT}`,
  description: `Receive performance reports directly in your GitHub Pull Requests, following a ${PRODUCT} deployment.`,
  published: '2020-02-24T03:50:35Z',
  authors: ['thefoxis'],
  url: '/guides/monitoring-performance-with-calibre-and-zeit-now',
  image: `https://og-image.now.sh/**Performance%20Monitoring**%20for%20${PRODUCT}%20Deployments%20with%20Calibre.png?theme=light&md=1&fontSize=88px&images=https%3A%2F%2Fassets.zeit.co%2Fimage%2Fupload%2Ffront%2Fassets%2Fdesign%2Fzeit-black-triangle.svg&images=https%3A%2F%2Fpbs.twimg.com%2Fprofile_images%2F1103494136768847873%2FM6AGVCx4_400x400.png`,
  editUrl: 'pages/guides/monitoring-performance-with-calibre-and-zeit-now.mdx',
  lastEdited: '2020-04-12T01:10:50.000Z'
}

[Calibre](https://calibreapp.com/) is a comprehensive monitoring platform that makes it easy to uncover and address performance issues. In this guide, you will learn how to receive performance [Pull Request Reviews](https://calibreapp.com/pull-request-reviews) directly in your pull requests following [<ProductNameSimple /> Deployment Previews](https://zeit.co/features/deployment-previews).

## Step 1: Deploy with <ProductNameWrapper name={PRODUCT} />
...
<Note type="warning">
  ...
  Request Reviews currently work with <ProductNameSimple /> and GitHub only.
