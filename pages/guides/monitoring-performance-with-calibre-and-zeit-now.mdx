...
export const meta = {
  ...
  description:
    `Receive performance reports directly in your GitHub Pull Requests, following a ${PRODUCT} deployment.`,
  published: '2020-02-24T03:50:35Z',
  authors: ['thefoxis'],
  url: '/guides/monitoring-performance-with-calibre-and-zeit-now',
  image:
    'https://og-image.now.sh/**Performance%20Monitoring**%20for%20ZEIT%20Now%20Deployments%20with%20Calibre.png?theme=light&md=1&fontSize=88px&images=https%3A%2F%2Fassets.zeit.co%2Fimage%2Fupload%2Ffront%2Fassets%2Fdesign%2Fzeit-black-triangle.svg&images=https%3A%2F%2Fpbs.twimg.com%2Fprofile_images%2F1103494136768847873%2FM6AGVCx4_400x400.png',
...
<Note type="warning">
  While <ProductName/> supports GitHub, Bitbucket, and GitLab, Calibre Pull Request
