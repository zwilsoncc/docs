...
[ZEIT Now](/now) supports configuration required to ignore source files and paths within your project. With a `.nowignore` file in your project directory, a source path can be prevented from being uploaded to ZEIT Now.
