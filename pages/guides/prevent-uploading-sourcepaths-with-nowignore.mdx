...
export const meta = {
  ...
  description:
    'Learn how to use a .nowignore file to prevent the uploading of source paths when deploying with ZEIT Now.',
...
<Note hint>
  ...
  the{' '}
  <GenericLink href="/docs/v2/build-step/#ignored-files-and-folders">
