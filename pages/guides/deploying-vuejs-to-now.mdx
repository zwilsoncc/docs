...
Create and deploy a new Vue.js project with ZEIT Now without the setup using the button below.

<a href="https://zeit.co/new/project?template=https://github.com/zeit/now-examples/tree/master/vue">
...
<Caption>Installing Vue CLI global to the system user with <GenericLink href="https://www.npmjs.com">npm</GenericLink>.</Caption>
