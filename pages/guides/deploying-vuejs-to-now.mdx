...
export const meta = {
  title: `Deploying a Vue.js App with ${PRODUCT}`,
  description: `Create your Vue.js app and deploy it with ${PRODUCT}.`,
  name: 'Vue.js',
  type: 'app',
...
## Step 2: Deploying Your Vue.js Project with <ProductNameWrapper name={PRODUCT} />
