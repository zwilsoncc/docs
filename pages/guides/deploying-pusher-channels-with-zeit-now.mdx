...
export const meta = {
  ...
  lastEdited: '2019-08-28T12:41:14.000Z'
}

[Pusher Channels](https://pusher.com/channels) is a service that makes it easy to add real-time data and functionality to web and mobile apps by using [WebSockets](https://socket.io/).
...
If you have not yet installed Now, you can do so by installing [Now CLI](/download). You are now ready to deploy your app with **just a single command**.
...
You can fine a full code example of an app made with this guide in [the ZEIT Now examples repository](https://github.com/zeit/now-examples/tree/master/vanilla-pusher-functions) on GitHub, along with the [live example](https://pusher-whiteboard.now-examples.now.sh/) deployed with ZEIT Now.
