...
Using [Now CLI](/download), add the following [Secrets](/docs/now-cli#commands/secrets) to your account and expose them as environment variables.
...
## Step 3: Deploying with <ProductName />
