...
ZEIT Now allows you to [deploy your project](/docs/v2/deployments/basics) from the terminal with **a single command**:
...
<Note>
  By default, ZEIT Now will cache static assets in every{' '}
  <Link href="/docs/v2/platform/regions-and-providers">region</Link>, making
  your site fast to load wherever you are in the world.
</Note>
