...
export const meta = {
  title: `Create a Charge App That Builds and Deploys with ${PRODUCT}`,
  description: `Deploy your Charge app with ${PRODUCT} in 3 easy steps.`,
  published: '2019-04-09T03:00:00.860Z',
  authors: ['msweeneydev'],
  url: '/guides/deploying-charge-with-now',
  demo: 'https://charge.now-examples.now.sh',
  image: `https://og-image.now.sh/**Deploy%20a%20Charge%20site**%20with%20${PRODUCT}.png?theme=light&md=1&fontSize=75px&images=https%3A%2F%2Fassets.zeit.co%2Fimage%2Fupload%2Ffront%2Fassets%2Fdesign%2Fzeit-black-triangle.svg&images=https%3A%2F%2Fd33wubrfki0l68.cloudfront.net%2F25151dcf9878a3c40b686628cc84c9292d95ca0e%2F9e22f%2Fimages%2Flogomark.svg`,
...
## Step 3: Deploy Your Charge Project with <ProductNameWrapper name={PRODUCT} />
