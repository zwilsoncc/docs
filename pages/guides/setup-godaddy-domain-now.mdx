...
export const meta = {
  title: `Setup a GoDaddy Domain with ${PRODUCT}`,
  description: `Use your GoDaddy registered domain for your ${PRODUCT} deployments.`,
...
## Step 2: Configuring Your Domain on <ProductNameWrapper name={PRODUCT} />
...
## Step 3: Pointing to <ProductNameWrapper name={PRODUCT} />
