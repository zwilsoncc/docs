...
import OrgName from '~/components/product-name/org-name'
import ProductName from '~/components/product-name'
import ProductNameWrapper from '~/components/product-name/wrapper'
import { PRODUCT_NAME } from '~/lib/constants'
import ProductShortName from '~/components/product-name/short'
...
export const meta = {
  ...
  lastEdited: '2020-04-13T22:14:13.000Z'
}
...
## Step 2: Configuring Your Domain on <ProductNameWrapper name={PRODUCT_NAME} />
...
Adding your production domain to a project can be done from the [<OrgName /> Dashboard](/dashboard) by selecting the project's **Domains** tab and entering it there, you can find more information on this in the [custom domains documentation](https://zeit.co/docs/v2/custom-domains/#adding-a-domain).
...
## Step 3: Pointing to <ProductNameWrapper name={PRODUCT_NAME} />
