...
export const meta = {
  ...
  description:
    'Use your GoDaddy registered domain for your ${PRODUCT} deployments.',
...
The first step of pointing an external domain to <ProductName/> is to add your domain to your ZEIT account or team and verifying ownership.
...
Once you have added the TXT record, your domain can be verified. ZEIT will periodically check your domain to see if it is verified, but if you do not want to wait and want to start using your domain with <ProductName/> immediately, use the following command to force a verification check:
...
That's all. Your domain is successfully migrated to using ZEIT DNS and pointing to your <ProductName/> deployed app.
