...
export const meta = {
  ...
  lastEdited: '2020-04-13T07:39:35.000Z'
}
...
To add a domain with [<ProductNameShort /> CLI](/docs/v2/getting-started/installation#now-cli), use the following command in your terminal:

<Snippet dark text="now domains add <domain>" />

Once you have added the domain, <ProductNameShort /> CLI will present you with some information about verifying it.
...
<Image
  ...
  oversize
/>
<Caption style={{marginTop: '-64px'}}>Adding a domain with <ProductNameShort /> CLI.</Caption>
...
If you want to verify with nameservers, you must use the intended set of nameservers given to you when you [added the domain with <ProductNameShort /> CLI](/docs/v2/custom-domains). If you need to be reminded of these nameservers, you can use the [following command](/docs/v2/custom-domains):
...
Select `TXT` as the record type to add, `_now` as the host, and the value you were given for the record when adding your domain or when using the [`now domains inspect <domain>` <ProductNameShort /> CLI command](/docs/v2/custom-domains).
...
<Image
  ...
  oversize
/>
<Caption style={{marginTop: '-64px'}}>Verifying a domain with <ProductNameShort /> CLI</Caption>
