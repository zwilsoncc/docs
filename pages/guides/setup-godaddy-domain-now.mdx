...
<Image
  src="https://zeit-inc-res.cloudinary.com/image/upload/v1548370520/front/guides/godaddy-migration/now-cli-add-domain.png"
  width={1562/2}
  height={1318/2}
  oversize
/>
...
<Image
  src="https://zeit-inc-res.cloudinary.com/image/upload/v1548370520/front/guides/godaddy-migration/godaddy-dashboard.png"
  width={1946/2}
  height={1350/2}
  oversize
/>
...
<Image
  src="https://zeit-inc-res.cloudinary.com/image/upload/v1548370520/front/guides/godaddy-migration/godaddy-dns-add.png"
  width={1946/2}
  height={1350/2}
  oversize
/>
...
<Image
  src="https://zeit-inc-res.cloudinary.com/image/upload/v1548370520/front/guides/godaddy-migration/now-cli-verify-domain.png"
  width={1562/2}
  height={808/2}
  oversize
/>
...
<Image
  src="https://zeit-inc-res.cloudinary.com/image/upload/v1548388022/front/guides/godaddy-migration/godaddy-ns-add.png"
  width={1946/2}
  height={1350/2}
  oversize
/>
