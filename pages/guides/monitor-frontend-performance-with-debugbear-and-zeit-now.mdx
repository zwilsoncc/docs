...
With your project set up with ZEIT, install the [DebugBear integration](https://zeit.co/integrations/debugbear) from the [ZEIT Integrations Marketplace](/integrations) to add it to your account.
...
/>
<Caption>Add the DebugBear integration and grant it access to the account that your project belongs to.</Caption>

## Step 3: Set Up a DebugBear Account

If you do not have a DebugBear account already, click **Create account** on DebugBear to automatically sign up with your ZEIT email address. Otherwise, you can continue with your existing account.

When logged in with DebugBear, select which of your ZEIT projects you would like to monitor and click **Set up**.
...
<Image
  ...
  oversize
/>
<Caption>Sign up to DebugBear and pick which ZEIT project you want to monitor.</Caption>
...
Make some changes to your project, then push the branch to your git repository. ZEIT will create a [Preview Deployment](/docs/v2/platform/deployments#preview), and DebugBear will test the performance of the deployed site.

You can see test results for your deployment in any of these places:

- The integration configuration page on ZEIT
...
2. Click **Install Github integration** and grant access to the repository that contains your ZEIT site.
