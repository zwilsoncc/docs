...
export const meta = {
  ...
  description: `Automatically test each ${ORGANIZATION} deployment and report performance changes to GitHub.`,
...
## Step 2: Install the DebugBear <ProductNameWrapper name={ORGANIZATION} /> Integration

With your project set up with <OrgName />, install the [DebugBear integration](https://zeit.co/integrations/debugbear) from the [<OrgName /> Integrations Marketplace](/integrations) to add it to your account.
