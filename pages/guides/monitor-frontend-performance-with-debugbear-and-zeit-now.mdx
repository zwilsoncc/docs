...
export const meta = {
  title: `Monitor Frontend Performance with DebugBear and ${PRODUCT}`,
  description: `Automatically test each ${PRODUCT_SIMPLE} deployment and report performance changes to GitHub.`,
  published: '2020-04-01T20:18:39.807Z',
  authors: ['mattzeunert'],
  url: '/guides/monitor-frontend-performance-with-debugbear-and-zeit-now',
  image: `https://og-image.now.sh/**Track%20website%20performance**%20with%20DebugBear%20and%20${PRODUCT}.png?theme=light&md=1&fontSize=96px&images=https%3A%2F%2Fassets.zeit.co%2Fimage%2Fupload%2Ffront%2Fassets%2Fdesign%2Fzeit-black-triangle.svg&images=https%3A%2F%2Fzeit.co%2Fdocs%2Fstatic%2Fguides%2Fmonitor-frontend-performance-with-debugbear-and-zeit-now%2Fdebubear-logo.png`,
  editUrl:
    'pages/guides/monitor-frontend-performance-with-debugbear-and-zeit-now.mdx',
...
## Step 1: Import and Deploy with <ProductNameWrapper name={PRODUCT} />

<DeploySection meta={meta} />

## Step 2: Install the DebugBear <ProductNameWrapper name={PRODUCT_SIMPLE} /> Integration

With your project set up with <ProductNameSimple />, install the [DebugBear integration](https://zeit.co/integrations/debugbear) from the [<ProductNameSimple /> Integrations Marketplace](/integrations) to add it to your account.
...
<Image
  src={`${
    process.env.ASSETS
  }/guides/monitor-frontend-performance-with-debugbear-and-zeit-now/install-zeit-integration.png`}
  width={1608 / 2}
  height={648 / 2}
  oversize
/>
...
If you do not have a DebugBear account already, click **Create account** on DebugBear to automatically sign up with your <ProductNameSimple /> email address. Otherwise, you can continue with your existing account.

When logged in with DebugBear, select which of your <ProductNameSimple /> projects you would like to monitor and click **Set up**.

<Image
  src={`${
    process.env.ASSETS
  }/guides/monitor-frontend-performance-with-debugbear-and-zeit-now/debugbear-signup.png`}
  width={1456 / 2}
  height={504 / 2}
  oversize
/>
<Caption>Sign up to DebugBear and pick which <ProductNameSimple /> project you want to monitor.</Caption>
...
<Image
  src={`${
    process.env.ASSETS
  }/guides/monitor-frontend-performance-with-debugbear-and-zeit-now/continuous-monitoring.png`}
  width={1067 / 2}
  height={727 / 2}
  oversize
  shadow
...
Make some changes to your project, then push the branch to your git repository. <ProductNameSimple /> will create a [Preview Deployment](/docs/v2/platform/deployments#preview), and DebugBear will test the performance of the deployed site.

You can see test results for your deployment in any of these places:

- The integration configuration page on <ProductNameSimple />
...
<Image
  src={`${
    process.env.ASSETS
  }/guides/monitor-frontend-performance-with-debugbear-and-zeit-now/zeit-builds.png`}
  width={1330 / 2}
  height={666 / 2}
  oversize
  shadow
/>
<Caption>Viewing build results on the <ProductNameSimple /> integration configuration page.</Caption>
...
2. Click **Install Github integration** and grant access to the repository that contains your <ProductNameSimple /> site.
...
<Image
  src={`${
    process.env.ASSETS
  }/guides/monitor-frontend-performance-with-debugbear-and-zeit-now/github-statuses.png`}
  width={1244 / 2}
  height={648 / 2}
  oversize
  shadow
/>
<Caption>GitHub commit statuses for a <ProductNameSimple /> deployment.</Caption>
