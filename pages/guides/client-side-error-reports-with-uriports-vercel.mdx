...
export const meta = {
  ...
  lastEdited: '2020-05-27T11:30:01.000Z'
}
  ...
  "routes": [
    {
      ...
      "headers": {
        ...
        "Permissions-Policy": "geolocation 'none'; camera 'none'; fullscreen *; payment 'self'"
      }
    }
  ]
}
...
Alternatively, run `vercel --prod` with <ProductShortName /> CLI from your project's root.
