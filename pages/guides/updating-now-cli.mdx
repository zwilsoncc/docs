...
When there is a new release of the [<ProductShortName /> CLI](https://zeit.co/download#now-cli) available, you will see a message appear in your terminal output when running <ProductName />, letting you know that there is a newer version.
