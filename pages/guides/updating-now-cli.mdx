...
export const meta = {
  title: `How to Update ${PRODUCT_SHORT} CLI`,
  description: `Update ${PRODUCT_SHORT} CLI using a package manager.`,
...
When there is a new release of the [<ProductNameShort /> CLI](https://zeit.co/download#now-cli) available, you will see a message appear in your terminal output when running <ProductName />, letting you know that there is a newer version.

This guide will take you through your options for updating <ProductNameShort /> CLI using your preferred package manager.
...
<Caption>Updating <ProductNameShort /> CLI using the <InlineCode>npm</InlineCode> command.</Caption>
...
<Caption>Updating <ProductNameShort /> CLI using the <InlineCode>yarn</InlineCode> command.</Caption>
