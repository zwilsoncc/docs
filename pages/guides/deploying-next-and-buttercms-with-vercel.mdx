...
export const meta = {
  ...
  type: 'app',
  lastEdited: '2020-06-02T23:37:58.000Z'
}
...
Create a `.env.local` file at the root of your project directory with the following code, adding your API key obtained in [step 1](#step-1:-create-your-buttercms-content) where instructed:
...
Lastly, to make your API key available for [cloud deployment](/docs/v2/deployments/basics/), create a [Secret](/docs/cli#commands/secrets) with the command below:

<Snippet dark text="vercel secrets add BUTTER_API_TOKEN your-space-id" />
<Caption>
  Adding the <InlineCode>BUTTER_API_TOKEN</InlineCode> secret to your project using <Link href="/docs/cli#commands/secrets">Secrets</Link>.
</Caption>
