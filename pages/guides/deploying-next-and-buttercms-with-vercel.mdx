...
export const meta = {
  ...
  authors: ['msweeneydev'],
  url: '/guides/deploying-next-and-buttercms-vercel',
  image: `${
    process.env.ASSETS
  }/guides/deploying-next-buttercms-vercel/deploying-next-buttercms-vercel.png`,
...
<Image
  src={`${
    process.env.ASSETS
  }/guides/deploying-next-buttercms-vercel/creating-collection.png`}
  width={1555/2}
  height={656/2}
  oversize
  shadow
...
<Image
  src={`${
    process.env.ASSETS
  }/guides/deploying-next-buttercms-vercel/completed-collection.png`}
  width={1503/2}
  height={592/2}
  oversize
  shadow
