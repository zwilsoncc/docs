...
export const meta = {
  title: `Create a Next.js and Storyblok App That Builds and Deploys with ${PRODUCT}`,
  description: `Use Storyblok as a Headless CMS to power content for your Next.js app deployed with ${PRODUCT}.`,
...
[Next.js](https://nextjs.org/) from [<OrgName />](https://zeit.co) is a **production-ready framework** that helps you create fast React apps. [Storyblok](https://www.storyblok.com/) is a headless CMS with a **visual editor, block system, custom field types and localization built in**.
...
<Caption>
  Adding the <InlineCode>STORYBLOK_API_TOKEN</InlineCode> secret to your project using <Link href="/docs/v2/deployments/environment-variables-and-secrets#securing-environment-variables-using-secrets"><ProductNameShort /> Secrets</Link>.
</Caption>
