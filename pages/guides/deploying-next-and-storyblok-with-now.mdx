...
export const meta = {
  ...
  description:
    'Learn how you can use Storyblok as a Headless CMS to power content for your Next.js app deployed with ZEIT Now.',
...
With your app ready, it is time to deploy it using **just a single command**:
