...
Now, when visiting either the production domain (www.your-domain.com), a [staging URL](/docs/v2/custom-domains#deploying-with-your-domain), or a [deployment URL](/docs/v2/advanced/concepts/urls/), the visitor will get redirected to the location set as defined by the [`routes` property](/docs/configuration#routes) in the `now.json` file.
