...
With your Hugo application set up, it is ready to deploy with [ZEIT Now](/docs/v2).
...
With ZEIT Now installed, you can deploy from your terminal with **a single command**:
