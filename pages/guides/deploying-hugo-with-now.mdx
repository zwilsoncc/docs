...
export const meta = {
  ...
  image:
    `https://og-image.now.sh/**Deploying%20Hugo%20Sites**%20%3Cbr%20%2F%3E%20with%20${PRODUCT}.png?theme=light&md=1&fontSize=100px&images=https%3A%2F%2Fassets.zeit.co%2Fimage%2Fupload%2Ffront%2Fassets%2Fdesign%2Fzeit-black-triangle.svg&images=https%3A%2F%2Fimg.stackshare.io%2Fservice%2F1158%2Fhugo-icon.png&widths=250&widths=300&heights=250&heights=300`,
...
## Step 2: Deploying Your Hugo Website with <ProductName/>
