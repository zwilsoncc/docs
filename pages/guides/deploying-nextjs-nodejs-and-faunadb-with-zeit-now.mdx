...
export const meta = {
  ...
  lastEdited: '2019-09-19T08:31:39.000Z'
}
...
This guide walks you through creating a [Next.js](https://nextjs.org) [app](https://nextjs-faunadb-nodejs.now-examples.now.sh/) that receives data from a [Node.js](https://nodejs.org/en/) API powered by [FaunaDB](https://fauna.com/), and how to deploy it with ZEIT Now.
