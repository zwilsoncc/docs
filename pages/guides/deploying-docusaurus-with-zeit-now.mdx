...
export const meta = {
  ...
  description:
    `Docusaurus with ${PRODUCT} makes it easy to create and deploy open source project documentation.`,
  ...
  image:
    `https://og-image.now.sh/**Deploy%20Docusaurus%20Sites**%20%3Cbr%2F%3E%20with%20${PRODUCT}.png?theme=light&md=1&fontSize=100px&images=https%3A%2F%2Fassets.zeit.co%2Fimage%2Fupload%2Ffront%2Fassets%2Fdesign%2Fzeit-black-triangle.svg&images=https%3A%2F%2Fv2.docusaurus.io%2Fimg%2Fdocusaurus_keytar.svg&widths=250&widths=350&heights=250&heights=300`,
...
## Step 2: Deploying Your Docusaurus Website with <ProductName/>
