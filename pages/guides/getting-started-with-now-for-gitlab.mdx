...
If you don't have a ZEIT account, visit [https://zeit.co/signup](https://zeit.co/signup) and click "Sign Up with GitLab".

### Link Your GitLab Projects

From the [account settings](/account) section where you connected your GitLab account, or from the GitLab tab on [https://zeit.co/new](https://zeit.co/new), select your GitLab project from the dropdown and click "link" to link it.
...
<Card title="Routes" href="/docs/v2/deployments/routes">
  Learn more about how Now uses routes to define the behavior of how a request is
