...
The [Now for GitLab integration](/docs/v2/integrations/now-for-gitlab) provides you with automatic deployments for each push to a project, automatic preview URLs for pushes to the default branch, and instant rollbacks for reverts.
...
For Now to make automatic deployments and preview URLs, it needs access to your GitLab account and its associated projects.
