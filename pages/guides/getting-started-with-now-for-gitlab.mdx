...
## Step 1: Set Up a <ProductNameWrapper name={PRODUCT_NAME} /> for GitLab Project
...
## Step 2: Connect <ProductNameWrapper name={PRODUCT_NAME} /> to Your GitLab User and Project
...
If you don't have a <OrgName /> account, visit <https://zeit.co/signup> and click "Sign Up with GitLab".
...
## Step 3: Using <ProductNameWrapper name={PRODUCT_NAME} /> for GitLab
