...
## Step 1: Set Up a <ProductNameWrapper name={PRODUCT} /> for GitLab Project
...
## Step 2: Connect <ProductNameWrapper name={PRODUCT} /> to Your GitLab User and Project
...
If you don't have a <ProductNameSimple /> account, visit <https://zeit.co/signup> and click "Sign Up with GitLab".
...
With a project linked, no further setup is required on <ProductNameSimple />.

## Step 3: Using <ProductNameWrapper name={PRODUCT} /> for GitLab
