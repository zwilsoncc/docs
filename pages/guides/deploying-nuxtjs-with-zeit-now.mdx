...
export const meta = {
  title: `Deploying a Static Nuxt.js App with ${PRODUCT}`,
  description: `Create and deploy your static Nuxt.js app with ${PRODUCT}.`,
  name: 'Nuxt.js',
  type: 'app',
...
## Step 2: Deploying Your Nuxt.js Project With <ProductNameWrapper name={PRODUCT} />
