...
export const meta = {
  title: `Deploy a Next.js and FaunaDB-Powered Guestbook with ${PRODUCT}`,
  description: `Create a Next.js and FaunaDB-Powered Guestbook App and deploy it with ${PRODUCT}.`,
...
## Step 3: Deploying Your App with <ProductNameWrapper name={PRODUCT} />
