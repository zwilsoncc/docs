...
If you are using either [ZEIT Now for GitHub](/docs/v2/more/now-for-github), [ZEIT Now for GitLab](/docs/v2/more/now-for-gitlab), or [ZEIT Now for Bitbucket](/docs/v2/more/now-for-bitbucket); pushing your code to your repository is all you need to do for ZEIT Now to automatically deploy your app.
