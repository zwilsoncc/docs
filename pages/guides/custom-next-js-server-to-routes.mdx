...
If you are using either [Now for GitHub](/docs/v2/more/now-for-github), [Now for GitLab](/docs/v2/more/now-for-gitlab), or [Now for Bitbucket](/docs/v2/more/now-for-bitbucket); pushing your code to your repository is all you need to do for Now to automatically deploy your app.
