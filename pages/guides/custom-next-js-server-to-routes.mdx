...
export const meta = {
  ...
  description:
    'Migrate from a Next.js app with a custom server to a serverless Next.js app using ${PRODUCT} routes.',
...
By making use of Next.js path segments with <ProductName/>, [dynamic routing](https://nextjs.org/docs#routing) is achieved through the file structure. No longer are custom servers or additional configuration required, **simplifying the process of building your app significantly**.
