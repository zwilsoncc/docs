...
export const meta = {
  title: `Deploying React Forms Using Formspree with ${PRODUCT}`,
  description: `Create and deploy a React form with the help of Formspree and ${PRODUCT}.`,
  published: '2019-09-12T12:00:00.860Z',
  authors: ['msweeneydev'],
  name: 'React + Formspree',
  type: 'app',
  url: '/guides/deploying-react-forms-using-formspree-with-zeit-now',
  image: `https://og-image.now.sh/**Deploying%20React%20and%20Formspree%20Forms**%20%3Cbr%20%2F%3E%20with%20${PRODUCT}.png?theme=light&md=1&fontSize=75px&images=https%3A%2F%2Fassets.zeit.co%2Fimage%2Fupload%2Ffront%2Fassets%2Fdesign%2Fzeit-black-triangle.svg&images=https%3A%2F%2Fformspree-icon.msweeneydev.now.sh%2Fformspree.svg&widths=250&widths=250&heights=200&heights=250`,
  editUrl:
