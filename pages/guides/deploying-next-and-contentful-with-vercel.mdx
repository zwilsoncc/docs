...
<Caption>
  Adding the <InlineCode>contentful_space_id</InlineCode> secret to your project using <Link href="/docs/cli#commands/secrets">Secrets</Link>.
</Caption>

<Snippet dark text="vercel secrets add contentful_access_token your-access-token" />
<Caption>
  Adding the <InlineCode>CONTENTFUL_ACCESS_TOKEN</InlineCode> secret to your project using <Link href="/docs/cli#commands/secrets">Secrets</Link>.
</Caption>
