...
export const meta = {
  ...
  lastEdited: '2019-08-22T08:02:02.000Z'
}
...
To provide your application with access to StaticKit components, run this command from the root of your project directory:
...
You can now deploy your StaticKit + Next.js application library with **a single command**:
...
If you want to deploy your StaticKit + Next.js application from a Git repository, you can use either [Now for GitHub](/docs/v2/advanced/now-for-github/) or [Now for GitLab](/docs/v2/advanced/now-for-gitlab/) to have your project automatically deployed on every push, and aliased on push to master.

For more information, you can find the [source code](https://github.com/levelhq/statickit-examples/tree/master/next-landing-page) for this example on GitHub.
