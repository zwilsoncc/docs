...
export const meta = {
  title: `Create and Deploy a Preact App with ${PRODUCT}`,
  description: `Create your Preact app and deploy it with ${PRODUCT}.`,
  name: 'Preact',
  type: 'app',
  ...
  image: `https://og-image.now.sh/**Deploy%20a%20Preact%20App**%20%3Cbr%3E%20with%20${PRODUCT}.png?theme=light&md=1&fontSize=100px&images=https%3A%2F%2Fassets.zeit.co%2Fimage%2Fupload%2Ffront%2Fassets%2Fdesign%2Fzeit-black-triangle.svg&images=https%3A%2F%2Fwww.stickpng.com%2Fassets%2Fimages%2F584815e7cef1014c0b5e4978.png`,
...
## Step 2: Deploying Your Preact Project with <ProductNameWrapper name={PRODUCT} />
