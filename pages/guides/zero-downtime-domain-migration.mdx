...
<Note>
  ...
  <Link href="/docs/v2/integrations/now-for-gitlab">Now for GitHub</Link>,
  <Link href="/docs/v2/integrations/now-for-gitlab">Now for GitLab</Link>, or 
  <Link href="/docs/v2/integrations/now-for-bitbucket">Now for Bitbucket</Link>.
</Note>
