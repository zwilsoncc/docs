...
<Caption>Adding a domain to a <OrgName /> account using <Link href="/now"><ProductShortName /> CLI</Link>.</Caption>
...
<Image
  ...
  height={1046/2}
/>
<Caption>Verifying a domain with <Link href="/now"><ProductShortName /> CLI</Link>.</Caption>
...
<Caption>Generating an SSL certificate for a domain and all subdomains with <Link href="/now"><ProductShortName /> CLI</Link>.</Caption>
