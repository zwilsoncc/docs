...
<Caption>Adding a domain to a <OrgName /> account using <Link href="/now"><ProductNameShort /> CLI</Link>.</Caption>
...
<Image
  ...
  height={1046/2}
/>
<Caption>Adding a domain with <Link href="/docs/v2/getting-started/installation"><ProductNameShort /> CLI</Link>.</Caption>
...
<Image
  ...
  height={1046/2}
/>
<Caption>Verifying a domain with <Link href="/now"><ProductNameShort /> CLI</Link>.</Caption>
...
With [<ProductNameShort /> CLI](/docs/v2/getting-started/installation), you can generate an SSL certificate for your domain and all subdomains, called common names (CNs), with the following command:

<Snippet dark text="now certs issue \*.<domain> <domain> --challenge-only" />
<Caption>Generating an SSL certificate for a domain and all subdomains with <Link href="/now"><ProductNameShort /> CLI</Link>.</Caption>
...
In this example, we'll take Gmail's current MX records and add them with <ProductNameShort /> CLI:
...
When the domain is verified, you can deploy your project to production with <ProductNameShort /> CLI:

<Snippet dark text="now --prod" />
<Caption>Deploying a project to production with <ProductNameShort /> CLI.</Caption>
