...
Using the [`alias`](/docs/v2/advanced/configuration/#alias) property inside of a [`now.json` file](/docs/v2/advanced/configuration), you can [automatically alias a deployment to your domain](/docs/v2/custom-domains#deploying-with-your-domain) by using the following Now CLI command in your terminal:
