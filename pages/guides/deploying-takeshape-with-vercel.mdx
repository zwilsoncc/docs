...
<Snippet dark text="vc secrets add next_example_cms_takeshape_api_key [your-takeshape-api-key]" />
<Caption>
...
<Snippet dark text="vc secrets add next_example_cms_takeshape_project_id [your-takeshape-project-id]" />
<Caption>
...
<Snippet dark text="vc secrets add next_example_cms_takeshape_preview_secret [your-random-string]" />
<Caption>
