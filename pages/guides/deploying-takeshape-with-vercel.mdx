...
export const meta = {
  ...
  image: `https://og-image.now.sh/**Deploy%20a%20TakeShape%20Blog**%20with%20${PRODUCT_NAME}%20%26%20Vercel.png?theme=light&md=1&fontSize=100px&images=https%3A%2F%2Fassets.vercel.com%2Fimage%2Fupload%2Ffront%2Fassets%2Fdesign%2Fvercel-triangle-black.svg&images=https%3A%2F%2Fassets.vercel.com%2Fimage%2Fupload%2Fv1592998293%2Ffront%2Fguides%2Fogp%2Ftakeshape.svg`,
  name: 'TakeShape',
  type: 'site',
  demo: 'https://next-blog-takeshape.now.sh/',
  editUrl: 'pages/guides/deploying-takeshape-with-vercel.mdx',
  lastEdited: '2020-06-24T11:36:18.000Z'
}
...
Using [<ProductShortName /> CLI](/download), create [Secrets](/docs/cli#commands/secrets) to securely store the API key, the project `id` from the TakeShape dashboard, and a preview secret.

<Snippet dark text="vercel secrets add next_example_cms_takeshape_api_key [your-takeshape-api-key]" />
<Caption>
...
<Snippet dark text="vercel secrets add next_example_cms_takeshape_project_id [your-takeshape-project-id]" />
<Caption>
...
<Snippet dark text="vercel secrets add next_example_cms_takeshape_preview_secret [your-random-string]" />
<Caption>
