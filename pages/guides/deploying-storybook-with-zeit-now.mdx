...
export const meta = {
  ...
  description:
    `Create a Svelte Component Library using Storybook and deploy it with ${PRODUCT}.`,
  name: 'Storybook',
  ...
  image:
    `https://og-image.now.sh/**Deploy%20a%20Storybook%20Library**%20%3Cbr%3E%20with%20${PRODUCT}.png?theme=light&md=1&fontSize=100px&images=https%3A%2F%2Fassets.zeit.co%2Fimage%2Fupload%2Ffront%2Fassets%2Fdesign%2Fzeit-black-triangle.svg&images=https%3A%2F%2Fpbs.twimg.com%2Fprofile_images%2F1100804485616566273%2FsOct-Txm_400x400.png`,
...
## Step 2: Deploying with <ProductName/>
