...
export const meta = {
  ...
  description:
    'How to create a Svelte Component Library using Storybook and deploy it with ZEIT Now.',
  ...
  lastEdited: '2019-08-21T11:13:44.000Z'
}
...
In this guide, you will discover how to set up a Svelte Storybook component library application with [Storybook CLI](https://github.com/storybookjs/storybook/tree/master/lib/cli) and how to deploy it with [ZEIT Now](/now).
...
<Caption>Bootstrapping a Svelte Storybook project with <GenericLink href="https://github.com/storybookjs/storybook/tree/master/lib/cli">Storybook CLI</GenericLink>.</Caption>
...
You can now deploy your Storybook component library with **just a single command**:
