...
export const meta = {
  ...
  lastEdited: '2019-11-06T21:09:50.000Z'
}
...
Set up a Stencil app with [`npm`](https://www.npmjs.com/) and move into the project directory, choosing either option **ionic-pwa** or **app**, and providing the name **my-stencil-project**:
