...
export const meta = {
  title: `Deploy Stencil with ${PRODUCT}`,
  description: `Create a Stencil app and deploy it live with ${PRODUCT}.`,
  name: 'Stencil',
  type: 'app',
...
## Step 2: Deploying Your Stencil App with <ProductNameWrapper name={PRODUCT} />
