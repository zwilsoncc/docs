...
export const meta = {
  ...
  lastEdited: '2019-11-15T15:07:40.000Z'
}
...
In this guide, you will discover how to create a Crystallize e-commerce site, that uses [Stripe](https://stripe.com/) to process payments, and deploy it with [ZEIT Now](/now).
