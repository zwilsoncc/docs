...
Using [Now CLI](/download), create [Secrets](/docs/now-cli#commands/secrets) to securely store the API keys received. You can find these in the `.env` file created by the project setup in [Step 2](#step-2:set-up-your-crystallize-project).
