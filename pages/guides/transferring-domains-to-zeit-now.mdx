...
When transferring a domain, you will have two options to choose from. Either using the [<OrgName /> Dashboard](https://zeit.co/dashboard/domains) or [Now CLI](/download).
