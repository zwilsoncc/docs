...
import { PRODUCT, ORGANIZATION, PRODUCT_SHORT_NAME } from '~/lib/constants'
...
When transferring a domain, you will have two options to choose from. Either using the [<OrgName /> Dashboard](https://zeit.co/dashboard/domains) or [<ProductShortName /> CLI](/download).
...
### Option 2: Using <ProductNameWrapper name={PRODUCT_SHORT_NAME} /> CLI
