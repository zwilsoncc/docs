...
export const meta = {
  ...
  description:
    `Create a simple Gatsby website and deploy it live with ${PRODUCT}.`,
  ...
  image:
    `https://og-image.now.sh/**Deploying%20Gatsby%20Sites**%20%3Cbr%20%2F%3E%20with%20${PRODUCT}.png?theme=light&md=1&fontSize=100px&images=https%3A%2F%2Fassets.zeit.co%2Fimage%2Fupload%2Ffront%2Fassets%2Fdesign%2Fzeit-black-triangle.svg&images=https%3A%2F%2Fcdn.svgporn.com%2Flogos%2Fgatsby.svg`,
...
## Step 2: Deploying Your Gatsby Website with <ProductName/>
