...
With a Gatsby app set up, it is ready to deploy live with [ZEIT Now](/docs/v2).

ZEIT Now allows you to [deploy your project](/docs/v2/deployments/basics) from the terminal with **a single command** using [Now CLI](/download):
