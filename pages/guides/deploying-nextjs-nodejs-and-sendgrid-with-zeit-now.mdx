...
Create a [<ProductShortName /> Secret](/docs/v2/serverless-functions/env-and-secrets/) to securely store the SendGrid API key, this will be used when deploying the app with <ProductName />.
...
Lastly, to make the [<ProductShortName /> Secret](https://zeit.co/docs/v2/serverless-functions/env-and-secrets/) available to the Serverless Function when deployed, create a `now.json` file:
...
## Step 4: Deploying the App with <ProductNameWrapper name={PRODUCT_NAME} />
