...
export const meta = {
  ...
  lastEdited: '2020-04-13T18:05:11.000Z'
}
...
Using [Now CLI](/download), create [Secrets](/docs/now-cli#commands/secrets) to securely store the API key, the project `id` from the TakeShape dashboard, and a preview secret.
