...
In this guide, you will discover how to create a [TakeShape blog](https://next-blog-takeshape.now.sh/), and deploy it with [ZEIT Now](/).
...
## Step 5: Deploying Your Blog with ZEIT Now
