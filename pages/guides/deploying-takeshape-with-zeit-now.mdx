...
export const meta = {
  ...
  description:
    `How to launch a blog site using Next.js and TakeShape on ${PRODUCT} in minutes.`,
  published: '2020-03-24T12:00:00.860Z',
  authors: ['msweeneydev'],
  url: '/guides/deploying-takeshape-with-zeit-now',
  image:
    `https://og-image.now.sh/**Deploy%20a%20TakeShape%20Blog**%20%3Cbr%2F%3E%20with%20${PRODUCT}.png?theme=light&md=1&fontSize=100px&images=https%3A%2F%2Fassets.zeit.co%2Fimage%2Fupload%2Ffront%2Fassets%2Fdesign%2Fzeit-black-triangle.svg&images=https%3A%2F%2Fph-files.imgix.net%2F3799c380-ef0b-4ce0-946e-2731effd6fa4%3Fauto%3Dformat&widths=200&widths=350&heights=200&heights=350`,
  name: 'TakeShape',
  type: 'site',
