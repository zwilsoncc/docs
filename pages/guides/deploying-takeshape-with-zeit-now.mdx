...
Using [<ProductShortName /> CLI](/download), create [<ProductShortName /> Secrets](/docs/v2/serverless-functions/env-and-secrets/) to securely store the API key, the project `id` from the TakeShape dashboard, and a preview secret.

<Snippet dark text="now secrets add next_example_cms_takeshape_api_key [your-takeshape-api-key]" />
<Caption>
  Adding the <InlineCode>next_example_cms_takeshape_api_key</InlineCode> as a <strong><ProductShortName /> Secret</strong>.
</Caption>
...
<Caption>
  Adding the <InlineCode>next_example_cms_takeshape_project_id</InlineCode> as a <strong><ProductShortName /> Secret</strong>.
</Caption>
...
<Caption>
  Adding the <InlineCode>next_example_cms_takeshape_preview_secret</InlineCode> as a <strong><ProductShortName /> Secret</strong>.
</Caption>
