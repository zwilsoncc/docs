...
Deploy this new version to <ProductName/> with `npm run deploy`. You minimal blog is now being served even faster thanks to the [ZEIT Smart CDN](/smart-cdn). You can try adding or modifying content in your Prismic repository and it **will be served instantaneously** on your now public site.
