...
<Snippet dark text="yarn global add prismic-cli" />
...
<Snippet dark text="yarn add prismic-javascript prismic-reactjs" />
...
// need to remove GenericLink href='localhost:3000' to enable
// export const config = {
// amp: 'hybrid'
// }
