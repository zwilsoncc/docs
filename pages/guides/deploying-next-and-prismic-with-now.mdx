...
So far, you have been using `npm run dev` to develop locally, but what good is a blog if you don't show it off to the world. It's time to deploy it to the ZEIT Now platform and enjoy your serverless web app.
...
Your minimalistic blog using Prismic and built with Next.js is now online on ZEIT Now and **can be shared instantly** using the URL given by the Now CLI.
