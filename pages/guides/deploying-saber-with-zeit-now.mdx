...
export const meta = {
  title: `Deploy Saber with ${PRODUCT}`,
  description: `Create a Saber site and deploy it live with ${PRODUCT}.`,
  name: 'Saber',
  type: 'app',
...
## Step 2: Deploying Your Saber Site with <ProductNameWrapper name={PRODUCT} />
