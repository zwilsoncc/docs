...
In this guide, we will show you how to parse a [Node.js request body](https://nodejs.org/en/docs/guides/anatomy-of-an-http-transaction/), for use inside a [Serverless Function](/docs/v2/serverless-functions/introduction/) deployed to [Now](/now), without requiring a framework such as Express.
...
The key part here is line 2. [Now](/now) adds a number of Express like [helper properties](/docs/v2/deployments/official-runtimes/node-js-now-node/#helpers) to make wording with Node.js even easier.
