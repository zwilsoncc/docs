...
export const meta = {
  title: 'Handling Node.js Request Bodies',
  description:
    'Learn how to parse Node.js request bodies for use inside serverless functions.',
...
Deploying your function to [Now](/now) is easy and can be done with **just a single command**:
