...
In this guide, we will show you how to parse a [Node.js request body](https://nodejs.org/en/docs/guides/anatomy-of-an-http-transaction/), for use inside a [Serverless Function](/docs/v2/advanced/concepts/serverless-functions/) deployed to [Now](/now), without requiring a framework such as Express.
