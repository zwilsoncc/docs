...
The key part here is line 2. [ZEIT Now](/) adds a number of Express like [helper properties](/docs/v2/deployments/official-runtimes/node-js-now-node/#helpers) to make wording with Node.js even easier.
