...
<Snippet dark text="yarn add apollo-server-micro graphql" />
<Caption>
...
<Note warning>
  Because the <InlineCode>index.js</InlineCode> file is placed at the root of
  the <InlineCode>/api</InlineCode> directory, the trailing slash is required
