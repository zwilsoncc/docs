...
export const meta = {
  ...
  type: 'app',
  lastEdited: '2020-04-13T07:48:36.000Z'
}
...
Lastly, to make your API key available for [cloud deployment](/docs/v2/deployments/basics/), create a [<ProductNameShort /> Secret](/docs/v2/deployments/environment-variables-and-secrets#securing-environment-variables-using-secrets) with the command below:

<Snippet dark text="now secrets add BUTTER_API_TOKEN your-space-id" />
<Caption>
  Adding the <InlineCode>BUTTER_API_TOKEN</InlineCode> secret to your project using <Link href="/docs/v2/deployments/environment-variables-and-secrets#securing-environment-variables-using-secrets"><ProductNameShort /> Secrets</Link>.
</Caption>
