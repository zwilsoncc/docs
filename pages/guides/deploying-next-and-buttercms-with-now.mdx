...
export const meta = {
  title: `Create a Next.js and ButterCMS App That Builds and Deploys with ${PRODUCT}`,
  description: `Deploy your Next.js and ButterCMS app with ${PRODUCT} in a serverless environment.`,
