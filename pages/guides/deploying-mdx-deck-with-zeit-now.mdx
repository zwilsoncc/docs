...
export const meta = {
  title: `Deploying MDX Deck with ${PRODUCT}`,
  description: `Create a React based slideshow with MDX Deck and deploy it with ${PRODUCT}.`,
  published: '2019-10-18T12:00:00.860Z',
  authors: ['msweeneydev'],
  url: '/guides/deploying-mdx-deck-with-zeit-now',
  demo: 'https://mdx-deck.now-examples.now.sh',
  image: `https://og-image.now.sh/**Deploy%20MDX%20Deck**%20%3Cbr%2F%3E%20with%20${PRODUCT}.png?theme=light&md=1&fontSize=100px&images=https%3A%2F%2Fassets.zeit.co%2Fimage%2Fupload%2Ffront%2Fassets%2Fdesign%2Fzeit-black-triangle.svg&images=https%3A%2F%2Fgithub.com%2Fjxnblk%2Fmdx-deck%2Fraw%2Fmaster%2Fdocs%2Face.png`,
  name: 'MDX Deck',
  type: 'app',
...
## Step 2: Deploying Your MDX Deck Project with <ProductNameWrapper name={PRODUCT} />
