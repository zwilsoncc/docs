...
<Snippet dark text="vercel secrets add sendgrid_api_key [your-sendgrid-api-key]" />
<Caption>
  Adding the access key as a <strong>Secret</strong>.
</Caption>

Lastly, to make the [Secret](/docs/now-cli#commands/secrets) available to the Serverless Function when deployed, create a `vercel.json` file:
