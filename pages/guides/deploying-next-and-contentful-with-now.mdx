...
In this guide, you will discover how to create a [Next.js](https://nextjs.org/) app that displays links to posts from the [<ProductNameSimple /> blog](/blog) by utilizing the [Contentful](https://www.contentful.com/) client, before deploying **with a single command** to [<ProductName />](/docs/v2).

[Next.js](https://nextjs.org/) from [<ProductNameSimple />](https://zeit.co) is a **production-ready framework** that helps you create fast React apps. [Contentful](https://www.contentful.com/) is a powerful headless CMS that allows you to **rapidly create, manage and distribute content** to any platform you like.
