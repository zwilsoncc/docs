...
export const meta = {
  ...
  type: 'app',
  lastEdited: '2020-04-13T22:02:22.000Z'
}

In this guide, you will discover how to create a [Next.js](https://nextjs.org/) app that displays links to posts from the [ZEIT blog](/blog) by utilizing the [Contentful](https://www.contentful.com/) client, before deploying **with a single command** to [<ProductName />](/docs/v2).
