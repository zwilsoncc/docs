...
Lastly, to make your API keys available for [cloud deployment](/docs/v2/deployments/basics/), create two [<ProductShortName /> Secrets](/docs/v2/deployments/environment-variables-and-secrets#securing-environment-variables-using-secrets) with the commands below:

<Snippet dark text="now secrets add CONTENTFUL_SPACE_ID your-space-id" />
<Caption>
  Adding the <InlineCode>CONTENTFUL_SPACE_ID</InlineCode> secret to your project using <Link href="/docs/v2/deployments/environment-variables-and-secrets#securing-environment-variables-using-secrets"><ProductShortName /> Secrets</Link>.
</Caption>

<Snippet dark text="now secrets add CONTENTFUL_ACCESS_TOKEN your-access-token" />
<Caption>
  Adding the <InlineCode>CONTENTFUL_ACCESS_TOKEN</InlineCode> secret to your project using <Link href="/docs/v2/deployments/environment-variables-and-secrets#securing-environment-variables-using-secrets"><ProductShortName /> Secrets</Link>.
</Caption>
