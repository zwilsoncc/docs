...
export const meta = {
  title: `Create a Next.js App with Contentful and Deploy It with ${PRODUCT}`,
  description: `Deploy your Next.js and Contentful app with ${PRODUCT} in a serverless environment.`,
...
[Next.js](https://nextjs.org/) from [<OrgName />](https://zeit.co) is a **production-ready framework** that helps you create fast React apps. [Contentful](https://www.contentful.com/) is a powerful headless CMS that allows you to **rapidly create, manage and distribute content** to any platform you like.
...
Lastly, to make your API keys available for [cloud deployment](/docs/v2/deployments/basics/), create two [<ProductNameShort /> Secrets](/docs/v2/deployments/environment-variables-and-secrets#securing-environment-variables-using-secrets) with the commands below:

<Snippet dark text="now secrets add CONTENTFUL_SPACE_ID your-space-id" />
<Caption>
  Adding the <InlineCode>CONTENTFUL_SPACE_ID</InlineCode> secret to your project using <Link href="/docs/v2/deployments/environment-variables-and-secrets#securing-environment-variables-using-secrets"><ProductNameShort /> Secrets</Link>.
</Caption>

<Snippet dark text="now secrets add CONTENTFUL_ACCESS_TOKEN your-access-token" />
<Caption>
  Adding the <InlineCode>CONTENTFUL_ACCESS_TOKEN</InlineCode> secret to your project using <Link href="/docs/v2/deployments/environment-variables-and-secrets#securing-environment-variables-using-secrets"><ProductNameShort /> Secrets</Link>.
</Caption>
