...
export const meta = {
  ...
  description: 'Deploy your Sanity Studio with ZEIT Now.',
...
This guide will walk you through how to deploy Sanity Studio with ZEIT Now in three simple steps.
...
Lastly, add `@sanity/cli` as a [development dependency](https://docs.npmjs.com/specifying-dependencies-and-devdependencies-in-a-package-json-file), this will allow [ZEIT Now](/now) to build your project on deployment.
...
You can choose whether you want to deploy the Studio directly from the command line, or from a Git repository by installing either the [ZEIT Now for GitHub](/docs/v2/more/now-for-github), [ZEIT Now for GitLab](/docs/v2/more/now-for-gitlab), or [ZEIT Now for Bitbucket](/docs/v2/more/now-for-bitbucket) integrations.
