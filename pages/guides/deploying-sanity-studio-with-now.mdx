...
export const meta = {
  title: `Deploying Sanity Studio with ${PRODUCT}`,
  description: `Deploy your Sanity Studio with ${PRODUCT}.`,
  name: 'Sanity Studio',
  type: 'app',
  published: '2019-05-30T03:00:00.000Z',
  authors: ['knut'],
  url: '/guides/deploying-sanity-studio-with-now',
  image: `https://og-image.now.sh/Deploy%20Sanity%20with%20${PRODUCT}.png?theme=light&md=1&fontSize=100px&images=https%3A%2F%2Fassets.zeit.co%2Fimage%2Fupload%2Ffront%2Fassets%2Fdesign%2Fzeit-black-triangle.svg&images=https%3A%2F%2Fcdn.sanity.io%2Fimages%2F3do82whm%2Fproduction%2F32ad3bafc3c20872754ca164eece005c6827fac4-186x247.svg`,
...
## Step 3: Deploy With <ProductNameWrapper name={PRODUCT} />
