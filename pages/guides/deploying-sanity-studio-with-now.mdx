...
export const meta = {
  ...
  description: 'Learn how to deploy your Sanity Studio with ZEIT Now.',
...
ZEIT Now provides an environment to deploy all types of projects, including static files, making it a good option for deploying your Sanity project with **just a single command**.
