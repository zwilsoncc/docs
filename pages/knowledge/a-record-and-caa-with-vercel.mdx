...
Testing is currently testing the [Anycast methodology](https://en.wikipedia.org/wiki/Anycast) for DNS and routing. This methodology allows those using a custom domain to verify it without requiring a change in nameservers.
