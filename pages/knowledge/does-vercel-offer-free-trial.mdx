...
export const meta = {
  ...
  editUrl: 'pages/docs/knowledge/does-vercel-offer-free-trial.mdx',
...
For working with a team, you will require a Pro account, this allows you to invite up to 10 members to work on projects with you.
