...
You may want to use different workflows and APIs based on on Git information. To support this, <ProductName /> will deploy your app with the following built-in environment variables when deploying with <ProductName /> for GitLab.
...
| ---------------------------- | ---------------------------------------------------------------------------- |
| `GITLAB_DEPLOYMENT`          | An indicator for whether the app was deployed by <ProductName /> for GitLab. |
