...
We require some permissions through our <ProductNameShort /> for GitHub integration. Below are listed the permissions required and a description for what they are used for.
