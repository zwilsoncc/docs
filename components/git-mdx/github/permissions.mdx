...
| `Deployments`     | Y    | Y     | Allows us to synchronize deployment status between GitHub and the <ProductNameSimple /> infrastructure.                   |
...
| `Commit Statuses` | Y    | Y     | Allows us to synchronize commit status between GitHub and <ProductNameSimple />.                                          |
