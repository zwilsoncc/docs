...
<Caption>Defining a <b>Now Secret</b> using <Link href="/now"><ProductNameShort /> CLI</Link>.</Caption>

To **remove a Now Secret**, use the following command:

<Snippet dark text="now secrets rm <secret-name>"/>
<Caption>Removing a <b>Now Secret</b> using <Link href="/now"><ProductNameShort /> CLI</Link>.</Caption>

To **rename a Now Secret**, use the following command:

<Snippet dark text="now secrets rename <secret-name> <new-name>"/>
<Caption>Renaming a <b>Now Secret</b> using <Link href="/now"><ProductNameShort /> CLI</Link>.</Caption>
