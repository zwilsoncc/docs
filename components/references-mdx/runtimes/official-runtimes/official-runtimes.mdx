...
When creating a new project, it automatically receives the latest Node.js version available on ZEIT Now. In order to understand which Node.js version your project is using, log the output of `process.version`.
