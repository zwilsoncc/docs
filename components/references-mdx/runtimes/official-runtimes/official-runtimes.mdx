...
The default Node.js version used is **10.x** but can be changed to **12.x** by defining [engines](https://docs.npmjs.com/files/package.json#engines) in `package.json`.
