...
This component renders a horizontal rule, similar to the [HTML hr](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/hr), styled to match <OrgName />'s design.
