...
For more examples of Integration implementations including the above example and others in more languages, such as PHP, Python, Go and Rust, [see the Integration Gallery repository](https://github.com/vercel/integrations).
