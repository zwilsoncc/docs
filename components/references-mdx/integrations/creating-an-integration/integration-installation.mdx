...
Then, you can select a <ProductNameSimple /> account to add the configuration to:
...
<Image
  ...
  height={1618/2}
/>
<Caption>Selecting a <ProductNameSimple /> account to add the configuration to.</Caption>
...
Once added, finding the configuration can be done by clicking the Integrations section through main navigation on the [<ProductNameSimple /> Dashboard](https://zeit.co/dashboard).
