...
Once added, finding the configuration can be done by clicking the Integrations section through main navigation on the [<OrgName /> Dashboard](https://zeit.co/dashboard).
