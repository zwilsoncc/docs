...
### Install Node.js and <ProductNameWrapper name={PRODUCT_SHORT} /> CLI
...
Next, install <ProductNameShort /> CLI with a package manager.

To install <ProductNameShort /> CLI with [npm](https://www.npmjs.com/), use the following from the terminal:

<TerminalInput>npm i -g now</TerminalInput>
<Caption>Installing <ProductNameShort /> CLI with npm.</Caption>
