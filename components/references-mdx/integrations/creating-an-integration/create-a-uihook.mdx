...
<Caption>
  An example <InlineCode>index.js</InlineCode> file for a <ProductNameSimple />{' '}
  Integration.
</Caption>
...
This is happening inside the <ProductNameSimple /> Dashboard under a configuration page for this Integration.
...
By running your UIHook locally, you can test that your Integration, after creating the Integration with <ProductNameSimple />, behaves as expected before deploying your Integration to production. This will be explored further in the next section.
