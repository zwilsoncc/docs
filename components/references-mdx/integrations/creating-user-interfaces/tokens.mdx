...
You can inspect the [API and methods of `zeitClient`](https://github.com/vercel/integration-utils/blob/master/src/zeit-client.ts) to understand its capabilities.
