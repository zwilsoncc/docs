...
The **Delete Hook** is a HTTP endpoint which is configured to receive HTTP [DELETE requests](https://developer.mozilla.org/en-US/docs/Web/HTTP/Methods/DELETE). After you create the endpoint in your app, you can add it to the Integration via the [Integration Console](/dashboard/integrations/console).
...
Take a look at [this example integration](https://github.com/vercel/integrations/tree/master/delete-hooks) to learn more about how Delete Hooks work.
