...
<Request
  url="https://api.zeit.co/v12/now/deployments"
  method="POST"
  headers={{
  ...
  body={{
    ...
    files: [
      {
        file: 'index.html',
        data: `<!doctype html>\n<html>\n  <head>\n    <title>A simple deployment with the ${PRODUCT} API!</title>\n  </head>\n  <body>\n    <h1>Welcome to a simple static file</h1>\n    <p>Deployed with <a href="https://zeit.co/docs/api">the ${PRODUCT} API</a>!</p>\n    </body>\n</html>`
      }
    ],
    projectSettings: {
      framework: null
...
<Request
  method="POST"
  url="https://api.zeit.co/v12/now/deployments?forceNew=1"
  headers={{
    'Content-Type': 'application/json'
  }}
  auth
...
<html>\n
  ...
  <body>\n
    &nbsp;<h1>My Instant ${PRODUCT} Deployment</h1>\n
    <p>Hello world!</p>\n
  </body>
</html>
`}
...
<Request
  method="GET"
  url="https://api.zeit.co/v12/now/deployments/dpl_89qyp1cskzkLrVicDaZoDbjyHuDJ"
  auth
/>
...
<Request
  method="DELETE"
  url="https://api.zeit.co/v12/now/deployments/dpl_5WJWYSyB7BpgTj3EuwF37WMRBXBtPQ2iTMJHJBJyRfd"
  auth
/>
...
<Request
  method="PATCH"
  url="https://api.zeit.co/v12/now/deployments/dpl_5WJWYSyB7BpgTj3EuwF37WMRBXBtPQ2iTMJHJBJyRfd/cancel"
  auth
/>
