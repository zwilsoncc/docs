...
| **gitSource**       | <HelpLink href="#api-basics/types">Map</HelpLink>          | No       | An object containing information to deploy a git repository. For example, <InlineCode noWrap>{ "type": "github", "repoId": 1238454 }</InlineCode>                                                                               |
...
### Create a Sourceless Deployment

With a sourceless deployment, you can deploy a Git repository with a single API request.
If Vercel doesn't have access to this repository, we cannot deploy.
So, make sure related repository has access to Vercel.
...
<Request
  ...
  auth
  body={{
    name: 'my-sourceless-deployment',
    gitSource: {
      type: 'github',
      repoId: 2434855,
      ref: 'master',
      sha: '246bd59caef39eb2c2c5097caacc25be31d75b30'
    }
  }}
/>

> `gitSource.sha` field is optional.
