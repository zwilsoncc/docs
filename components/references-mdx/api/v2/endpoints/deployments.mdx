...
<Endpoint method="POST" url="/v11/now/deployments" />
...
<Request
  method="POST"
  url="https://api.zeit.co/v11/now/deployments?forceNew=1"
  headers={{
    'Content-Type': 'application/json'
  }}
  auth
...
<Request
  method="GET"
  url="https://api.zeit.co/v11/now/deployments/dpl_89qyp1cskzkLrVicDaZoDbjyHuDJ"
  auth
/>
...
<Request
  method="DELETE"
  url="https://api.zeit.co/v11/now/deployments/dpl_5WJWYSyB7BpgTj3EuwF37WMRBXBtPQ2iTMJHJBJyRfd"
  auth
/>
...
<Request
  url="https://api.zeit.co/v11/now/deployments/dpl_BRGyoU2Jzzwx7myBnqv3xjRDD2GnHTwUWyFybnrUvjDD/files"
  auth
/>
...
<Request
  url="https://api.zeit.co/v11/now/deployments/dpl_BRGyoU2Jzzwx7myBnqv3xjRDD2GnHTwUWyFybnrUvjDD/files/2d4aad419917f15b1146e9e03ddc9bb31747e4d0"
  auth
/>
...
<Request
  url="https://api.zeit.co/v11/now/deployments/dpl_BRGyoU2Jzzwx7myBnqv3xjRDD2GnHTwUWyFybnrUvjDD/builds"
  auth
/>
