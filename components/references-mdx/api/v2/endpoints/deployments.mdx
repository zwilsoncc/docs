...
| **version**   | <HelpLink href="#api-basics/types">Integer</HelpLink>      | Yes      | The version of ZEIT Now Platform to use. Must have the value of `2`.                                                                                                                                                            |
...
| **version**       | <HelpLink href="#api-basics/types">Integer</HelpLink>      | The ZEIT Now platform version the deployment is associated with.                                                                                                                                          |
...
<html>\n
  ...
  <body>\n
    &nbsp;<h1>My Instant ZEIT Now Deployment</h1>\n
    <p>Hello world!</p>\n
  </body>
</html>
"
