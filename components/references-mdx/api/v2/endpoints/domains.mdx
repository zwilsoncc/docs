...
<Request
  method="POST"
  url={`${API_ENDPOINT}/v4/domains/my-zeit-domain.website/verify`}
  headers={{
    'Content-Type': 'application/json'
  }}
  auth
...
<Request url={`${API_ENDPOINT}/v4/domains/my-zeit-domain.website`} auth />
...
<Request
  method="DELETE"
  url={`${API_ENDPOINT}/v4/domains/my-zeit-domain.website`}
  auth
/>
...
<Request
  url={`${API_ENDPOINT}/v4/domains/status?name=my-zeit-domain.website`}
  auth
/>
...
<Request url={`${API_ENDPOINT}/v4/domains/price?name=zeit.rocks`} auth />
