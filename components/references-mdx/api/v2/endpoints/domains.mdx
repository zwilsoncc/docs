...
import CdnName from '~/components/product-name/cdn'
...
| **serviceType**         | <HelpLink href="#api-basics/types">String</HelpLink>       | The type of service the domain is handled by. `external` if the DNS is externally handled, or `zeit.world` if handled with <ProductNameSimple />. |
...
| **expiresAt**           | <HelpLink href="#api-basics/types">Date</HelpLink>         | The date at which the domain is set to expire. `null` if not bought with <ProductNameSimple />.                                                   |
...
| **intendedNameservers** | <HelpLink href="#api-basics/types">List</HelpLink>         | A list of the intended nameservers for the domain to point to <ProductNameSimple /> DNS.                                                          |
...
<Request url="https://api.zeit.co/v5/domains" auth />
...
| **expiresAt**           | <HelpLink href="#api-basics/types">Date</HelpLink>         | The date at which the domain is set to expire. `null` if not bought with <ProductNameSimple />.                                                               |
| **boughtAt**            | <HelpLink href="#api-basics/types">Date</HelpLink>         | If it was purchased through <ProductName />, the date when it was purchased.                                                                                  |
| **transferStartedAt**   | <HelpLink href="#api-basics/types">Date</HelpLink>         | If transferred into <ProductNameSimple />, The date when the domain transfer was initiated                                                                    |
| **transferredAt**       | <HelpLink href="#api-basics/types">Date</HelpLink>         | The date at which the domain was successfully transferred into <ProductNameSimple />. `null` if the transfer is still processing or was never transferred in. |
| **verifiedRecord**      | <HelpLink href="#api-basics/types">ID</HelpLink>           | The ID of the verification record in the registry.                                                                                                            |
| **verified**            | <HelpLink href="#api-basics/types">Boolean</HelpLink>      | If the domain has the ownership verified.                                                                                                                     |
| **nameservers**         | <HelpLink href="#api-basics/types">List</HelpLink>         | A list of the current nameservers of the domain.                                                                                                              |
| **intendedNameservers** | <HelpLink href="#api-basics/types">List</HelpLink>         | A list of the intended nameservers for the domain to point to <ProductNameSimple /> DNS.                                                                      |
...
Initiate a domain transfer request from an external Registrar to <ProductNameSimple />.
...
| **transferredAt**       | <HelpLink href="#api-basics/types">Date</HelpLink>         | The date at which the domain was successfully transferred into <ProductNameSimple />. `null` if the transfer is still processing.                 |
| **verifiedRecord**      | <HelpLink href="#api-basics/types">ID</HelpLink>           | The ID of the verification record in the registry.                                                                                                |
| **verified**            | <HelpLink href="#api-basics/types">Boolean</HelpLink>      | If the domain has the ownership verified.                                                                                                         |
| **nameservers**         | <HelpLink href="#api-basics/types">List</HelpLink>         | A list of the current nameservers of the domain.                                                                                                  |
| **intendedNameservers** | <HelpLink href="#api-basics/types">List</HelpLink>         | A list of the intended nameservers for the domain to point to <ProductNameSimple /> DNS.                                                          |
