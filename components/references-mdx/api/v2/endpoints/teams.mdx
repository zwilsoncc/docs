...
<Endpoint method="GET" url="/v1/teams/:id/request" />
...
| Key                     | <HelpLink href="#api-basics/types" hasIcon>Type</HelpLink> | Description                                                                                                                                                                                                                                                                                    |
| ----------------------- | ---------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **confirmed**           | <HelpLink href="#api-basics/types">Boolean</HelpLink>      | The value is `true` for users that were already accepted. If they are in a pending state it'll be `false`.                                                                                                                                                                                     |
| **accessRequestedAt**   | <HelpLink href="#api-basics/types">Date</HelpLink>         | Timestamp in milliseconds that indicates when the user requested access.                                                                                                                                                                                                                       |
| **joinedFrom.origin**   | <HelpLink href="#api-basics/types">Enum</HelpLink>         | Where the member has joined the team from. Either <InlineCode>mail</InlineCode>, <InlineCode>link</InlineCode>, <InlineCode>import</InlineCode>, <InlineCode>onboarding</InlineCode>, <InlineCode>github</InlineCode>, <InlineCode>gitlab</InlineCode>, or <InlineCode>bitbucket</InlineCode>. |
| **joinedFrom.commitId** | <HelpLink href="#api-basics/types">String</HelpLink>       | This field is set for GitHub, GitLab, and Bitbucket. The SHA of the commit that will be deployed.                                                                                                                                                                                              |
| **joinedFrom.repoId**   | <HelpLink href="#api-basics/types">String</HelpLink>       | This field is set for GitHub, GitLab, and Bitbucket. The ID of the repository that will be deployed. For GitHub and Bitbucket it can be a number.                                                                                                                                              |
