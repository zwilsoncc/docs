...
By default it returns 20 secrets. The rest can be retrieved using the pagination options described bellow.
...
<Request url="https://api.zeit.co/v3/now/secrets" auth />
