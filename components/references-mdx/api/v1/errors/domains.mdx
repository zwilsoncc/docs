...
export const meta = {
  ...
  lastEdited: '2019-10-22T09:25:48.000Z'
}
...
We were able to purchase a domain for you but we had an error when trying to add it to your account. Please contact us at <SupportLink /> or via <EmailLink type="support" />.
