...
export const meta = {
  editUrl: 'pages/docs/api/v1/api-docs-mdx/endpoints/secrets.mdx',
...
<OutputTable>
  <Row>
    ...
    <Cell>
      The unique identifier of the secret. Always prepended with{' '}
      <InlineCode>sec_</InlineCode>.
    </Cell>
  </Row>
  <Row>
    ...
    <Cell>
      The name of the secret. This is what you could use in your environment
      variables after a <InlineCode>@</InlineCode>.
    </Cell>
  </Row>
  <Row>
...
<Request
  method={`${API_ENDPOINT}/v2/now/secrets`}
  headers={{
...
<OutputTable>
  <Row>
    ...
    <TypeCell>String</TypeCell>
    <Cell>
      The type of structure used to save the secret value (always{' '}
