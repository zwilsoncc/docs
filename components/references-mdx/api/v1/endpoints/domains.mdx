...
<OutputTable>
  ...
  <Row>
    ...
    <TypeCell>Date</TypeCell>
    <Cell>
      If it was purchased through {<ProductShortNameV1 />} the date when it was
      purchased.
    </Cell>
  </Row>
  <Row>
...
Register a new domain name with <ProductShortNameV1 /> for the authenticating
...
Delete a previously registered domain name from <ProductShortNameV1 />.
