...
<OutputTable>
  ...
  <Row>
    ...
    <TypeCell>Date</TypeCell>
    <Cell>
      If it was purchased through {<ProductNameShortV1 />} the date when it was
      purchased.
    </Cell>
  </Row>
  <Row>
...
Register a new domain name with <ProductNameShortV1 /> for the authenticating
...
Delete a previously registered domain name from <ProductNameShortV1 />.
