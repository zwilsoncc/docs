...
<InputTable>
  <Row>
    ...
    <Cell>
      ...
      values.{' '}
      <i>
        Now Secret may be referenced by prefixing the value with{' '}
  ...
  <Row>
    ...
    <Cell>
      ...
      defined as the{' '}
      <ExternalLink href="https://docs.npmjs.com/files/package.json#engines">
  ...
  <Row>
    ...
    <Cell>
      ...
      <InternalLink href="/docs/features/configuration#local-configuration">
        local configuration
      </InternalLink>{' '}
...
<OutputTable>
  ...
  <Row>
    ...
    <Cell>
      ...
      <InternalLink href="/docs/getting-started/scaling">
        scale configuration
      </InternalLink>{' '}
      of the deployment.
    </Cell>
