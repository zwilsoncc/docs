...
<Snippet dark text="vercel remove [deployment-url]" />
<Caption>Using the <InlineCode>vercel remove</InlineCode> command to remove a deployment from the <ProductName /> platform.</Caption>

### Extended Usage

<Snippet dark text="vercel remove [deployment-url-1 deployment-url-2]" />
<Caption>Using the <InlineCode>vercel remove</InlineCode> command to remove multiple deployments from the <ProductName /> platform.</Caption>

<Snippet dark text="vercel remove [project-name]" />
<Caption>Using the <InlineCode>vercel remove</InlineCode> command to remove all deployments for a project from the <ProductName /> platform.</Caption>
...
The following [global options](#options) can be passed when using the `vercel remove` command:
...
<Snippet dark text="vercel remove my-project --safe" />
<Caption>Using the <InlineCode>vercel remove</InlineCode> command with the <InlineCode>--safe</InlineCode> option.</Caption>
...
<Snippet dark text="vercel remove my-deployment.com --yes" />
<Caption>Using the <InlineCode>vercel remove</InlineCode> command with the <InlineCode>--yes</InlineCode> option.</Caption>
