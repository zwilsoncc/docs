...
This file is used for global configuration of <ProductName /> deployments. Now CLI uses this file as a way to co-ordinate how deployments should be treated, consistently.
