...
import Deprecated from '~/components/text/deprecated'
import Name from './name.mdx'
import Version from './version.mdx'
import Alias from './alias.mdx'
import Scope from './scope.mdx'
import Builds from './builds.mdx'
import Public from './public.mdx'
import CleanUrls from './clean-urls.mdx'
import TrailingSlash from './trailing-slash.mdx'
import Redirects from './redirects.mdx'
import Rewrites from './rewrites.mdx'
