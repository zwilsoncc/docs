...
To deploy your <Author name={props.name} /> <Type type={props.type} /> with a [ZEIT Now for Git Integration](/docs/v2/git-integrations), make sure it has been pushed to a Git repository.

[Import the project](/import) into ZEIT Now using your Git Integration of choice:
