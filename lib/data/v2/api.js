        ...
        posts: [
          {
            ...
            name: 'Get Build Logs',
            href: '/api/v2#endpoints/logs/get-build-logs'
          },
          {
            id: 'logsStreamFunction',
            name: 'Stream Serverless Function logs',
            href: '/api/v2#endpoints/logs/stream-serverless-function-logs'
          },
          {
            id: 'logsGetFailedRequests',
            name: 'Get the failed requests of a Serverless Function',
            href:
              '/api/v1#endpoints/logs/fetch-failed-requests-for-serverless-function'
          }
        ]
      },
      {
