export default [
  ...
  },
  {
    ...
    posts: [
      {
        name: 'ZEIT Now for GitHub',
        href: '/docs/v2/more/now-for-github'
      },
      {
        name: 'ZEIT Now for GitLab',
        href: '/docs/v2/more/now-for-gitlab'
      },
      {
        name: 'ZEIT Now for Bitbucket',
        href: '/docs/v2/more/now-for-bitbucket'
      },
      {
        name: 'Deploy Button',
