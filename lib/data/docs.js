export default [
    ...
    posts: [
      {
        ...
        href: '/docs/getting-started/introduction-to-now',
        aliases: ['/docs']
      },
      {
        name: 'Deployment',
      ...
      },
      {
        ...
        href: '/docs/getting-started/assign-a-domain-name'
      },
      {
        name: 'Logs',
      ...
      {
        name: 'Secrets',
        href: '/docs/getting-started/secrets'
      },
      {
        name: 'Scaling',
    ...
    posts: [
      {
        ...
        href: '/docs/static-deployments/introduction-and-deploying'
      },
      {
        name: 'Configuration',
        href: '/docs/static-deployments/configuration'
      },
      {
        name: 'Builds',
        posts: [
          {
            ...
            href: '/docs/static-deployments/builds/building-with-now'
          }
        ]
      }
    ]
...

  {
    ...
    posts: [
      {
        name: 'Docker',
        href: '/docs/deployment-types/docker'
      },
      {
        name: 'Node.js',
        href: '/docs/deployment-types/node'
      }
    ]
  },

  {
    ...
    posts: [
      ...
      {
        name: 'CDN',
        href: '/docs/features/cdn'
      },
      {
        name: 'Build-Time Env and Secrets',
        href: '/docs/features/build-env-and-secrets'
      },
      {
        name: 'Run-Time Env and Secrets',
        href: '/docs/features/env-and-secrets'
      },
      {
        name: 'Configuration',
      ...
      },
      {
        ...
        href: '/docs/features/certs'
      },
      {
        name: 'Private NPM',
        href: '/docs/features/private-npm'
      },
      {
      ...
      {
        name: 'Path Aliases',
        href: '/docs/features/path-aliases'
      }
    ]
  },

  {
    ...
    posts: [
      {
        name: 'Now for GitHub',
        href: '/docs/integrations/now-for-github'
      }
    ]
  },
    ...
    posts: [
      {
        ...
        href: '/docs/guides/app-lifecycle-and-scalability'
      },
      {
...

  {
    ...
    posts: [
      ...
      },
      {
        ...
        href: '/docs/examples/slack-slash'
      },
      {
        name: 'Realtime Chat',
        href: '/docs/examples/chat'
      },
      {
        name: 'GraphQL App',
        href: '/docs/examples/graphql'
      },
      {
    ...
    posts: [
      {
        ...
        href: '/docs/other/support-channels'
      },
      {
        name: 'FAQ',
        href: '/docs/other/faq'
