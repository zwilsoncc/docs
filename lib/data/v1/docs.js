import { CLI_NAME_V1, PRODUCT_SHORT_NAME_V1 } from '~/lib/constants'
...
export default [
  {
    ...
    posts: [
      {
        name: `Introduction to ${PRODUCT_SHORT_NAME_V1}`,
...

  {
    ...
    posts: [
      ...
      },
      {
        ...
        posts: [
          {
            name: `Building with ${PRODUCT_SHORT_NAME_V1}`,
...

  {
    ...
    posts: [
      {
        name: `${PRODUCT_SHORT_NAME_V1} for GitHub`,
