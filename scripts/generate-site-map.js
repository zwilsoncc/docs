    ...
    meta = eval(
      '(' +
        match[1]
          ...
          .replace(/\${PRODUCT_V1}/g, productNames.productV1)
          .replace(/\${ORGANIZATION_V1}/g, productNames.organizationV1)
          .replace(/\${PRODUCT_SHORT_V1}/g, productNames.productShortV1)
          .replace(/\${CLI_V1}/g, productNames.cliV1) +
        ')'
    )
